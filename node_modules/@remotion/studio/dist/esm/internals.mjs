...
import React166, { useCallback as useCallback123, useEffect as useEffect71, useMemo as useMemo122 } from "react";
...
import { useCallback as useCallback86, useMemo as useMemo91, useState as useState54 } from "react";
...
import { useCallback as useCallback83, useContext as useContext52, useEffect as useEffect52, useMemo as useMemo89 } from "react";
...
import { useCallback as useCallback62, useEffect as useEffect41, useMemo as useMemo72, useState as useState44 } from "react";
...
import React85, { useMemo as useMemo71, useState as useState43 } from "react";
...
var ZodUnionEditor = ({
  ...
  if (options.length > 2) {
    return /* @__PURE__ */ jsx128(ZonNonEditableValue, {
      jsonPath,
...
var ZodSwitch = ({
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx129(ZodObjectEditor, {
      setValue,
      unsavedValue: value,
      savedValue: defaultValue,
      jsonPath,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodString) {
    if (value.startsWith(window.remotion_staticBase)) {
      return /* @__PURE__ */ jsx129(ZodStaticFileEditor, {
        setValue,
        value,
        jsonPath,
        schema,
    ...
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_TEXTAREA_BRAND) {
      return /* @__PURE__ */ jsx129(ZodTextareaEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    return /* @__PURE__ */ jsx129(ZodStringEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDate) {
    return /* @__PURE__ */ jsx129(ZodDateEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNumber) {
    return /* @__PURE__ */ jsx129(ZodNumberEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodBoolean) {
    return /* @__PURE__ */ jsx129(ZodBooleanEditor, {
      value,
      setValue,
      jsonPath,
      defaultValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodArray) {
    return /* @__PURE__ */ jsx129(ZodArrayEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEnum) {
    return /* @__PURE__ */ jsx129(ZodEnumEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEffects) {
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_COLOR_BRAND) {
      return /* @__PURE__ */ jsx129(ZodColorEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    return /* @__PURE__ */ jsx129(ZodEffectEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodUnion) {
    return /* @__PURE__ */ jsx129(ZodUnionEditor, {
      schema,
      showSaveButton,
      jsonPath,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodOptional) {
    return /* @__PURE__ */ jsx129(ZodOptionalEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNullable) {
    return /* @__PURE__ */ jsx129(ZodNullableEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDefault) {
    return /* @__PURE__ */ jsx129(ZodDefaultEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDiscriminatedUnion) {
    return /* @__PURE__ */ jsx129(ZodDiscriminatedUnionEditor, {
      defaultValue,
      mayPad,
      schema,
      setValue,
...
var ZodObjectEditor = ({
  ...
  return /* @__PURE__ */ jsxs65(Fieldset, {
    ...
    success: localValue.zodValidation.success,
    children: [
      isRoot ? null : /* @__PURE__ */ jsx130(SchemaLabel, {
        isDefaultValue,
        onReset: reset,
        jsonPath,
        onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx130(RevisionContextProvider, {
        children: /* @__PURE__ */ jsx130(SchemaVerticalGuide, {
          isRoot,
          children: keys.map((key, i) => {
            ...
            return /* @__PURE__ */ jsxs65(React85.Fragment, {
              children: [
                ...
                i === keys.length - 1 ? null : /* @__PURE__ */ jsx130(SchemaSeparationLine, {})
              ]
            }, key);
          })
        })
      }) : null,
      isRoot || !expanded ? null : /* @__PURE__ */ jsx130("div", {
        style: fieldsetLabel,
        children: "}"
      })
    ]
...
var SchemaEditor = ({
  ...
  const keybindings = useKeybinding();
  const [revision, setRevision] = useState44(0);
  const revisionState = useMemo72(() => {
    return {
  ...
  if (!zodValidationResult.success) {
    ...
    if (!defaultPropsValid.success) {
      return /* @__PURE__ */ jsx131(InvalidDefaultProps, {
        zodValidationResult
      });
    }
    return /* @__PURE__ */ jsx131(InvalidSchema, {
      reset,
      zodValidationResult
    });
  }
  if (typeName !== z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx131(TopLevelZodValue, {
      typeReceived: typeName
    });
  }
  return /* @__PURE__ */ jsx131("div", {
    ref: defaultPropsEditorScrollableAreaRef,
    style: scrollable2,
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: /* @__PURE__ */ jsx131(RevisionContext.Provider, {
      value: revisionState,
      children: /* @__PURE__ */ jsx131(ZodObjectEditor, {
        discriminatedUnionReplacement: null,
...
var WarningTriangle2 = (props) => {
  return /* @__PURE__ */ jsx132("svg", {
    viewBox: "0 0 576 512",
    ...props,
    children: /* @__PURE__ */ jsx132("path", {
      d: "M248.747 204.705l6.588 112c.373 6.343 5.626 11.295 11.979 11.295h41.37a12 12 0 0 0 11.979-11.295l6.588-112c.405-6.893-5.075-12.705-11.979-12.705h-54.547c-6.903 0-12.383 5.812-11.978 12.705zM330 384c0 23.196-18.804 42-42 42s-42-18.804-42-42 18.804-42 42-42 42 18.804 42 42zm-.423-360.015c-18.433-31.951-64.687-32.009-83.154 0L6.477 440.013C-11.945 471.946 11.118 512 48.054 512H527.94c36.865 0 60.035-39.993 41.577-71.987L329.577 23.985zM53.191 455.002L282.803 57.008c2.309-4.002 8.085-4.002 10.394 0l229.612 397.993c2.308 4-.579 8.998-5.197 8.998H58.388c-4.617.001-7.504-4.997-5.197-8.997z"
    })
  });
};
var WarningIndicatorButton = ({ setShowWarning, showWarning, warningCount }) => {
  ...
  return /* @__PURE__ */ jsxs66("button", {
    ...
    onClick,
    children: [
      /* @__PURE__ */ jsx132(WarningTriangle2, {
        style: triangleStyle2
      }),
      /* @__PURE__ */ jsx132(Spacing, {
        x: 0.5
      }),
      warningCount,
      /* @__PURE__ */ jsx132(Spacing, {
...
var DataEditor = ({
  ...
  const serializedJSON = useMemo74(() => {
    if (!inJSONEditor) {
      return null;
    }
  ...
  const [canSaveDefaultPropsObjectState, setCanSaveDefaultProps] = useState45({
  ...
  const zodValidationResult = useMemo74(() => {
    if (schema === "no-zod") {
      return "no-zod";
    }
    if (schema === "no-schema") {
  ...
  const canSaveDefaultProps = useMemo74(() => {
  ...
  if (schema === "no-zod") {
    return /* @__PURE__ */ jsx133(ZodNotInstalled, {});
  }
  if (schema === "no-schema") {
    return /* @__PURE__ */ jsx133(NoSchemaDefined, {});
  }
  if (!z) {
    throw new Error("expected zod");
  }
  ...
  if (!unresolvedComposition.defaultProps) {
    return /* @__PURE__ */ jsx133(NoDefaultProps, {});
  }
  return /* @__PURE__ */ jsxs67("div", {
    style: outer,
    children: [
      /* @__PURE__ */ jsxs67("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs67("div", {
            style: tabWrapper,
            children: [
              /* @__PURE__ */ jsx133(SegmentedControl, {
                items: modeItems,
                needsWrapping: false
              }),
              /* @__PURE__ */ jsx133(Flex, {}),
              warnings.length > 0 ? /* @__PURE__ */ jsx133(WarningIndicatorButton, {
                setShowWarning,
                showWarning,
          ...
          showWarning && warnings.length > 0 ? warnings.map((warning) => /* @__PURE__ */ jsxs67(React88.Fragment, {
            children: [
              ...
              /* @__PURE__ */ jsx133(ValidationMessage, {
                message: warning,
                align: "flex-start",
                type: "warning"
              })
      ...
      mode === "schema" ? /* @__PURE__ */ jsx133(SchemaEditor, {
      ...
      }) : /* @__PURE__ */ jsx133(RenderModalJSONPropsEditor, {
        value: defaultProps ?? {},
        setValue: setDefaultProps,
        onSave: onUpdate,
        showSaveButton,
...
import React98, { useContext as useContext40, useEffect as useEffect44, useMemo as useMemo81 } from "react";
...
var RenderQueueCopyToClipboard = ({ job }) => {
  const renderCopyAction = useCallback65((color) => {
    return /* @__PURE__ */ jsx134(ClipboardIcon, {
  ...
  return /* @__PURE__ */ jsx134(InlineAction, {
...
var CircularProgress = ({ progress }) => {
  ...
  return /* @__PURE__ */ jsx137("svg", {
    ...
    children: /* @__PURE__ */ jsx137("circle", {
...
var RenderQueueItemStatus = ({ job }) => {
  ...
  if (job.status === "running") {
    return /* @__PURE__ */ jsx138("button", {
      ...
      style: invisibleStyle,
      onClick,
      children: /* @__PURE__ */ jsx138(CircularProgress, {
...
import { useCallback as useCallback69, useMemo as useMemo76 } from "react";
...
var RenderQueueOpenInFinderItem = ({ job }) => {
  ...
  const renderAction = useCallback69((color) => {
    return /* @__PURE__ */ jsx139(ExpandedFolderIconSolid, {
      style: icon4,
      color
    });
  }, [icon4]);
  return /* @__PURE__ */ jsx139(InlineAction, {
    renderAction,
    onClick
  });
};
...
import { useCallback as useCallback71, useMemo as useMemo78 } from "react";
...
var RenderQueueRemoveItem = ({ job }) => {
  ...
  const renderAction = useCallback71((color) => {
    return /* @__PURE__ */ jsx142("svg", {
      style: icon4,
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 320 512",
      children: /* @__PURE__ */ jsx142("path", {
        fill: color,
        d: "M310.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L160 210.7 54.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L114.7 256 9.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L160 301.3 265.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L205.3 256 310.6 150.6z"
      })
    });
...
import { useCallback as useCallback72, useContext as useContext38, useMemo as useMemo79 } from "react";
...
// src/components/RenderQueue/RenderQueueItem.tsx
import { jsx as jsx144, jsxs as jsxs68 } from "react/jsx-runtime";
var container29 = {
  padding: 12,
  display: "flex",
  flexDirection: "row",
...
var RenderQueueItem = ({ job, selected }) => {
  ...
  const containerStyle2 = useMemo80(() => {
    return {
      ...container29,
      backgroundColor: getBackgroundFromHoverState({
  ...
  return /* @__PURE__ */ jsxs68(Row, {
    ...
    children: [
      /* @__PURE__ */ jsx144(RenderQueueItemStatus, {
        job
      }),
      /* @__PURE__ */ jsx144(Spacing, {
        x: 1
      }),
      /* @__PURE__ */ jsxs68("div", {
        style: right,
        children: [
          ...
          /* @__PURE__ */ jsx144("div", {
            style: subtitle2,
            children: job.status === "done" ? /* @__PURE__ */ jsx144(RenderQueueOutputName, {
              job
            }) : job.status === "failed" ? /* @__PURE__ */ jsx144(RenderQueueError, {
              job
            }) : job.status === "running" ? /* @__PURE__ */ jsx144(RenderQueueProgressMessage, {
              job
            }) : null
          })
        ]
      ...
      supportsCopyingToClipboard(job) ? /* @__PURE__ */ jsx144(RenderQueueCopyToClipboard, {
        job
      }) : null,
      job.status === "done" || job.status === "failed" ? /* @__PURE__ */ jsx144(RenderQueueRepeatItem, {
        job
      }) : null,
      job.status === "running" ? /* @__PURE__ */ jsx144(RenderQueueCancelButton, {
        job
      }) : /* @__PURE__ */ jsx144(RenderQueueRemoveItem, {
        job
      }),
      job.status === "done" ? /* @__PURE__ */ jsx144(RenderQueueOpenInFinderItem, {
        job
      }) : null
    ]
  });
...
// src/components/RenderQueue/index.tsx
import { jsx as jsx145, jsxs as jsxs69 } from "react/jsx-runtime";
var separatorStyle = {
  borderBottom: `1px solid ${BORDER_COLOR}`
};
  ...
  return /* @__PURE__ */ jsx145("div", {
    ...
    children: jobs.map((j, index) => {
      return /* @__PURE__ */ jsx145("div", {
        ...
        children: /* @__PURE__ */ jsx145(RenderQueueItem, {
...
import { useContext as useContext41, useMemo as useMemo82 } from "react";
import { Internals as Internals34 } from "remotion";
import { jsx as jsx146, jsxs as jsxs70, Fragment as Fragment20 } from "react/jsx-runtime";
var row3 = {
  display: "flex",
  flexDirection: "row",
  fontSize: 14,
...
var RendersTab = ({ selected, onClick }) => {
  ...
  const jobCount = jobs.length;
  const isActuallySelected = useMemo82(() => {
    if (!canvasContent || canvasContent.type !== "composition") {
      return true;
    }
    return selected;
  }, [canvasContent, selected]);
  const badgeStyle = useMemo82(() => {
    return {
      ...badge,
...
var OptionsPanel = ({ readOnlyStudio }) => {
  ...
  const [panel, setPanel] = useState47(() => getSelectedPanel2(readOnlyStudio));
  ...
  const currentDefaultProps = useMemo83(() => {
    if (composition === null) {
      return {};
    }
    return props[composition.id] ?? composition.defaultProps ?? {};
  }, [composition, props]);
  const unsavedChangesExist = useMemo83(() => {
  ...
  return /* @__PURE__ */ jsxs71("div", {
    ...
    children: [
        ...
        children: /* @__PURE__ */ jsxs71(Tabs, {
          children: [
            composition ? /* @__PURE__ */ jsxs71(Tab, {
              ...
              children: [
                "Props",
                unsavedChangesExist ? /* @__PURE__ */ jsx147(GlobalPropsEditorUpdateButton, {
                  compositionId: composition.id,
                  currentDefaultProps
                }) : null
              ]
            }) : null,
            readOnlyStudio ? null : /* @__PURE__ */ jsx147(RendersTab, {
      ...
      panel === `input-props` && composition ? /* @__PURE__ */ jsx147(DataEditor, {
        ...
        setSaving,
        readOnlyStudio
      }, composition.id) : readOnlyStudio ? null : /* @__PURE__ */ jsx147(RenderQueue, {})
    ]
  });
};

// src/components/PreviewToolbar.tsx
import { useContext as useContext49, useState as useState50 } from "react";
...
var CheckboardToggle = () => {
  ...
  return /* @__PURE__ */ jsx148(ControlButton, {
...
var FpsCounter = ({ playbackSpeed }) => {
  ...
  const [marker, rerender] = useState48({});
  const [fps, setFps] = useState48(0);
...
import { useCallback as useCallback76, useContext as useContext44, useEffect as useEffect47 } from "react";
...
var MuteToggle = ({ muted, setMuted }) => {
  ...
  return /* @__PURE__ */ jsx152(ControlButton, {
    ...
    onClick,
    children: muted ? /* @__PURE__ */ jsx152(VolumeOffIcon, {}) : /* @__PURE__ */ jsx152(VolumeOnIcon, {})
  });
};

// src/components/PlayPause.tsx
import { PlayerInternals as PlayerInternals13 } from "@remotion/player";
import { useCallback as useCallback79, useEffect as useEffect48, useState as useState49 } from "react";
...
var Pause = (props) => /* @__PURE__ */ jsx154("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
var Play = (props) => /* @__PURE__ */ jsx155("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
// src/components/PlayPause.tsx
import { jsx as jsx158, jsxs as jsxs73, Fragment as Fragment21 } from "react/jsx-runtime";
var backStyle = {
  height: 18,
  color: "white"
};
...
var PlayPause = ({ playbackRate, loop, bufferStateDelayInMilliseconds }) => {
  ...
  const [showBufferIndicator, setShowBufferState] = useState49(false);
  const {
    playing,
    play,
    pause,
  ...
  return /* @__PURE__ */ jsxs73(Fragment21, {
    children: [
      /* @__PURE__ */ jsx158(ControlButton, {
        "aria-label": "Jump to beginning",
        title: "Jump to beginning",
        disabled: !videoConfig || isFirstFrame,
        onClick: jumpToStart,
        children: /* @__PURE__ */ jsx158(JumpToStart, {
          style: backStyle
        })
      }),
      /* @__PURE__ */ jsx158(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx158(StepBack, {
      ...
      /* @__PURE__ */ jsx158(ControlButton, {
        ...
        children: playing ? showBufferIndicator ? /* @__PURE__ */ jsx158(PlayerInternals13.BufferingIndicator, {
          type: "studio"
        }) : /* @__PURE__ */ jsx158(Pause, {
          style: iconButton
        }) : /* @__PURE__ */ jsx158(Play, {
          style: iconButton
        })
      }),
      /* @__PURE__ */ jsx158(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx158(StepForward, {
          style: forwardBackStyle
        })
      })
    ]
...
import { useCallback as useCallback80, useEffect as useEffect49 } from "react";
...
import { useContext as useContext46, useMemo as useMemo85 } from "react";
...
var PlaybackRateSelector = ({ playbackRate, setPlaybackRate }) => {
  ...
  const items = useMemo85(() => {
    ...
    const values = commonPlaybackRates.map((newPlaybackRate) => {
      return {
        ...
        keyHint: null,
        leftItem: String(playbackRate) === String(newPlaybackRate) ? /* @__PURE__ */ jsx159(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
  ...
  return /* @__PURE__ */ jsx159("div", {
    style: style9,
    "aria-label": accessibilityLabel5,
    children: /* @__PURE__ */ jsx159(Combobox, {
      title: accessibilityLabel5,
      style: comboStyle2,
...
import { useCallback as useCallback81, useContext as useContext47, useMemo as useMemo86 } from "react";
import { Internals as Internals41 } from "remotion";
import { jsx as jsx160, jsxs as jsxs74 } from "react/jsx-runtime";
var button3 = {
  paddingLeft: 7,
  paddingRight: 7,
  paddingTop: 7,
...
var RenderButton = () => {
  ...
  return /* @__PURE__ */ jsx160(Button, {
    ...
    children: /* @__PURE__ */ jsxs74(Row, {
      align: "center",
      children: [
        /* @__PURE__ */ jsx160(RenderIcon, {
          svgProps: iconStyle4
        }),
        /* @__PURE__ */ jsx160(Spacing, {
          x: 1
        }),
        /* @__PURE__ */ jsx160("span", {
          style: label7,
          children: "Render"
        })
      ]
  ...
  return /* @__PURE__ */ jsxs75("div", {
    ...
    children: [
      /* @__PURE__ */ jsx162(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx162(Minus, {
          style: iconStyle4
        })
      }),
...
// src/components/PreviewToolbar.tsx
import { jsx as jsx163, jsxs as jsxs76, Fragment as Fragment22 } from "react/jsx-runtime";
var container31 = {
  display: "flex",
  justifyContent: "center",
...
var PreviewToolbar = ({ readOnlyStudio, bufferStateDelayInMilliseconds }) => {
  ...
  const isStill = useIsStill();
  const [loop, setLoop] = useState50(loadLoopOption());
  const isFullscreenSupported = checkFullscreenSupport();
    ...
    children: [
      /* @__PURE__ */ jsxs76("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx163(TimelineZoomControls, {})
        ]
      }),
      /* @__PURE__ */ jsx163(Flex, {}),
      /* @__PURE__ */ jsx163(SizeSelector, {}),
      isStill || isVideoComposition ? /* @__PURE__ */ jsx163(PlaybackRateSelector, {
        setPlaybackRate,
        playbackRate
      }) : null,
      isVideoComposition ? /* @__PURE__ */ jsxs76(Fragment22, {
        children: [
          ...
          /* @__PURE__ */ jsx163(LoopToggle, {
            loop,
            setLoop
          }),
          /* @__PURE__ */ jsx163(MuteToggle, {
            muted: mediaMuted,
          ...
          /* @__PURE__ */ jsx163(TimelineInOutPointToggle, {}),
          /* @__PURE__ */ jsx163(Spacing, {
            x: 2
          })
        ]
      }) : null,
      /* @__PURE__ */ jsx163(CheckboardToggle, {}),
      /* @__PURE__ */ jsx163(Spacing, {
        x: 1
      }),
      isFullscreenSupported && /* @__PURE__ */ jsx163(FullScreenToggle, {}),
      /* @__PURE__ */ jsx163(Flex, {}),
      /* @__PURE__ */ jsxs76("div", {
        style: sideContainer,
        children: [
          /* @__PURE__ */ jsx163(Flex, {}),
          /* @__PURE__ */ jsx163(FpsCounter, {
            playbackSpeed: playbackRate
          }),
          /* @__PURE__ */ jsx163(Spacing, {
            x: 2
          }),
          readOnlyStudio ? null : /* @__PURE__ */ jsx163(RenderButton, {}),
          /* @__PURE__ */ jsx163(Spacing, {
            x: 1.5
          })
        ]
      }),
      /* @__PURE__ */ jsx163(PlaybackKeyboardShortcutsManager, {
        setPlaybackRate
      }),
      /* @__PURE__ */ jsx163(PlaybackRatePersistor, {})
    ]
  });
};

// src/components/Splitter/SplitterContainer.tsx
import { useMemo as useMemo87, useRef as useRef27, useState as useState51 } from "react";
...
var SplitterContainer = ({ orientation, children, defaultFlex, maxFlex, minFlex, id }) => {
  ...
  const [flexValue, setFlexValue] = useState51(initialTimelineFlex ?? defaultFlex);
  const ref = useRef27(null);
  const isDragging = useRef27(false);
  const value = useMemo87(() => {
    return {
      flexValue,
      ref,
      setFlexValue,
  ...
  return /* @__PURE__ */ jsx164(SplitterContext.Provider, {
    value,
...
import { useContext as useContext50, useMemo as useMemo88 } from "react";
import { interpolateColors, random } from "remotion";
import { jsx as jsx165, jsxs as jsxs77, Fragment as Fragment23 } from "react/jsx-runtime";
...
import { useContext as useContext51, useEffect as useEffect51, useRef as useRef28, useState as useState52 } from "react";
...
var SplitterHandle = ({ allowToCollapse, onCollapse }) => {
  ...
  const [lastPointerUp, setLastPointerUp] = useState52(() => Date.now());
...
var useResponsiveSidebarStatus = () => {
  ...
  const actualStateLeft = useMemo89(() => {
...
var TopPanel = ({ readOnlyStudio, onMounted, drawRef: drawRef2, bufferStateDelayInMilliseconds }) => {
  ...
  const actualStateRight = useMemo89(() => {
  ...
  const canvasContainerStyle = useMemo89(() => ({
    flex: 1,
    display: "flex",
    ...
    children: [
      /* @__PURE__ */ jsx167("div", {
        ...
        children: /* @__PURE__ */ jsxs78(SplitterContainer, {
          ...
          orientation: "vertical",
          children: [
            actualStateLeft === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx167(MobilePanel, {
              onClose: onCollapseLeft,
              children: /* @__PURE__ */ jsx167(ExplorerPanel, {
                readOnlyStudio
              })
            }) : /* @__PURE__ */ jsx167(SplitterElement, {
              sticky: null,
              type: "flexer",
              children: /* @__PURE__ */ jsx167(ExplorerPanel, {
                readOnlyStudio
            ...
            actualStateLeft === "expanded" ? /* @__PURE__ */ jsx167(SplitterHandle, {
                ...
                children: [
                  /* @__PURE__ */ jsx167(SplitterElement, {
                    ...
                    children: /* @__PURE__ */ jsx167("div", {
                      ...
                      children: /* @__PURE__ */ jsx167(CanvasIfSizeIsAvailable, {})
                    })
                  }),
                  actualStateRight === "expanded" ? /* @__PURE__ */ jsx167(SplitterHandle, {
                    allowToCollapse: "right",
                    onCollapse: onCollapseRight
                  }) : null,
                  actualStateRight === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx167(MobilePanel, {
                    onClose: onCollapseRight,
                    children: /* @__PURE__ */ jsx167(OptionsPanel, {
                      readOnlyStudio
                    })
                  }) : /* @__PURE__ */ jsx167(SplitterElement, {
                    sticky: null,
      ...
      /* @__PURE__ */ jsx167(PreviewToolbar, {
        bufferStateDelayInMilliseconds,
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx167(CurrentCompositionKeybindings, {
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx167(TitleUpdater, {})
    ]
  });
};

// src/components/SidebarCollapserControls.tsx
import { jsx as jsx168, jsxs as jsxs79, Fragment as Fragment24 } from "react/jsx-runtime";
var style9 = {
  width: 16,
  height: 16,
  minWidth: 16,
...
var UpdateCheck = () => {
  ...
  const dynButtonStyle = useMemo90(() => {
    return {
      ...buttonStyle4,
  ...
  return /* @__PURE__ */ jsx169("button", {
    tabIndex,
    style: dynButtonStyle,
    onClick: openModal,
    type: "button",
    title: hasKnownBugs ? "Bugfixes available" : "Update available",
    children: hasKnownBugs ? "Bugfixes available" : /* @__PURE__ */ jsx169("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      style: {
        height: 16,
        width: 16
...
var MenuToolbar = ({ readOnlyStudio }) => {
  const [selected, setSelected] = useState54(null);
  const mobileLayout = useMobileLayout();
  const fixedWidthRight = useMemo91(() => {
    return {
  ...
  const fixedWidthLeft = useMemo91(() => {
    return {
  ...
  return /* @__PURE__ */ jsxs80(Row, {
    ...
    children: [
      /* @__PURE__ */ jsxs80("div", {
        ...
        children: [
          structure.map((s) => {
            return /* @__PURE__ */ jsx170(MenuItem, {
          ...
          readOnlyStudio ? null : /* @__PURE__ */ jsx170(UpdateCheck, {})
        ]
      }),
      /* @__PURE__ */ jsx170("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx170(MenuBuildIndicator, {}),
      /* @__PURE__ */ jsx170("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx170("div", {
        style: fixedWidthRight,
        children: /* @__PURE__ */ jsx170(SidebarCollapserControls, {})
      }),
      /* @__PURE__ */ jsx170(Spacing, {
        x: 1
      })
    ]
  });
...
import { useContext as useContext63, useMemo as useMemo102 } from "react";
...
import { jsx as jsx171, jsxs as jsxs82, Fragment as Fragment25 } from "react/jsx-runtime";
var areaHighlight = {
  position: "absolute",
...
var TimelineInOutPointer = () => {
  ...
  return /* @__PURE__ */ jsxs82(Fragment25, {
    children: [
      inFrame !== null && /* @__PURE__ */ jsx171("div", {
        ref: inMarkerAreaRef,
        style: {
          ...areaHighlight,
          left: 0,
      ...
      outFrame !== null && /* @__PURE__ */ jsx171("div", {
...
import { createRef as createRef10, useContext as useContext56, useMemo as useMemo92 } from "react";
...
var TimelineInOutPointerHandle = ({
  ...
  return /* @__PURE__ */ jsx172(InnerTimelineInOutPointerHandle, {
    atFrame,
    dragging,
    timelineWidth,
    type
...
var TimelineDragHandler = () => {
  ...
  const containerStyle2 = useMemo93(() => {
    if (!canvasContent || canvasContent.type !== "composition") {
      return {};
    }
    const zoom = zoomMap[canvasContent.compositionId] ?? TIMELINE_MIN_ZOOM;
  ...
  return /* @__PURE__ */ jsx173("div", {
    ref: sliderAreaRef,
    style: containerStyle2,
    children: video ? /* @__PURE__ */ jsx173(Inner2, {}) : null
  });
};
var Inner2 = () => {
  ...
  const { inFrame, outFrame } = useTimelineInOutFramePosition();
  const { setInAndOutFrames } = useTimelineSetInOutFramePosition();
  const [dragging, setDragging] = useState55({
    dragging: false
  });
  ...
  const outContextMenu = useMemo93(() => {
    return [
      {
        id: "hide-out",
        keyHint: null,
  ...
  return /* @__PURE__ */ jsxs83("div", {
    ...
    children: [
      ...
      inFrame !== null && /* @__PURE__ */ jsx173(ContextMenu, {
        values: inContextMenu,
        children: /* @__PURE__ */ jsx173(TimelineInOutPointerHandle, {
          type: "in",
          atFrame: inFrame,
          dragging: inOutDragging.dragging === "in"
        })
      }),
      outFrame !== null && /* @__PURE__ */ jsx173(ContextMenu, {
...
import { useCallback as useCallback90, useContext as useContext59, useMemo as useMemo95 } from "react";
...
var TimelineLayerEye = ({ onInvoked, hidden, type }) => {
  const renderAction = useCallback88((color) => {
    ...
    if (type === "speaker") {
      return /* @__PURE__ */ jsx174("svg", {
        viewBox: "0 0 10 14",
        fill: "none",
        style: speakerIcon,
        children: /* @__PURE__ */ jsx174("path", {
...
// src/components/Timeline/TimelineStack/index.tsx
import { jsx as jsx175, jsxs as jsxs84, Fragment as Fragment26 } from "react/jsx-runtime";
...
var TimelineStack = ({ isCompact, sequence }) => {
  const [originalLocation, setOriginalLocation] = useState56(null);
  const [stackHovered, setStackHovered] = useState56(false);
  ...
  return /* @__PURE__ */ jsxs84(Fragment26, {
    children: [
      ...
      isCompact || !originalLocation ? null : /* @__PURE__ */ jsx175("div", {
...
var TimelineListItem = ({ nestedDepth, sequence, isCompact }) => {
  ...
  const padder = useMemo95(() => {
    return {
      width: Number(SPACING * 1.5) * nestedDepth,
      flexShrink: 0
    };
  }, [nestedDepth]);
  const isItemHidden = useMemo95(() => {
  ...
  return /* @__PURE__ */ jsxs85("div", {
    style: outer2,
    children: [
      /* @__PURE__ */ jsx176(TimelineLayerEye, {
      ...
      sequence.parent && nestedDepth > 0 ? /* @__PURE__ */ jsx176("div", {
        style: space
      }) : null,
      /* @__PURE__ */ jsx176(TimelineStack, {
        sequence,
        isCompact
      })
    ]
...
import { useContext as useContext60, useEffect as useEffect57, useMemo as useMemo96, useRef as useRef30 } from "react";
...
var TimelineTimePlaceholders = () => {
  return /* @__PURE__ */ jsx177("div", {
    style: timeValue,
    children: /* @__PURE__ */ jsx177(TimeValue, {})
  });
};
...
var Inner3 = ({ windowWidth, durationInFrames, fps }) => {
  ...
  return /* @__PURE__ */ jsx177("div", {
    ...
    children: ticks.map((t) => {
      return /* @__PURE__ */ jsx177("div", {
        style: t.style,
        children: t.showTime ? /* @__PURE__ */ jsx177("div", {
          style: tickLabel,
...
var TimelineList = ({ timeline }) => {
  ...
  return /* @__PURE__ */ jsxs86("div", {
    ...
    style: container37,
    children: [
      /* @__PURE__ */ jsx178(TimelineTimePadding, {}),
      timeline.map((track) => {
        return /* @__PURE__ */ jsx178("div", {
          children: /* @__PURE__ */ jsx178(TimelineListItem, {
...
import { useMemo as useMemo97 } from "react";
...
var TimelineScrollable = ({ children }) => {
  const containerStyle2 = useMemo97(() => {
    return {
      width: "100%",
      minHeight: "100%"
    };
...
import { useContext as useContext62, useMemo as useMemo100, useState as useState59 } from "react";
...
import { useEffect as useEffect59, useMemo as useMemo99, useRef as useRef32, useState as useState57 } from "react";
...
// src/components/AudioWaveform.tsx
import { jsx as jsx181, jsxs as jsxs87 } from "react/jsx-runtime";
var container39 = {
  display: "flex",
  flexDirection: "row",
  alignItems: "center",
...
var AudioWaveform = ({
  ...
  const [metadata, setMetadata] = useState57(null);
  ...
  return /* @__PURE__ */ jsxs87("div", {
    ...
    children: [
      normalized.map((w) => {
        return /* @__PURE__ */ jsx181(AudioWaveformBar, {
          amplitude: w.amplitude
        }, w.index);
      }),
      /* @__PURE__ */ jsx181("canvas", {
        ref: canvas,
        style: canvasStyle,
...
var Icon = () => /* @__PURE__ */ jsx182("svg", {
  viewBox: "0 0 512 512",
  style: icon4,
  children: /* @__PURE__ */ jsx182("path", {
    fill: LIGHT_COLOR,
...
// src/components/Timeline/LoopedTimelineIndicators.tsx
import { jsx as jsx183, jsxs as jsxs89 } from "react/jsx-runtime";
var row6 = {
  flexDirection: "row"
};
var LoopedTimelineIndicator = ({ loops }) => {
  return /* @__PURE__ */ jsx183(AbsoluteFill3, {
    style: row6,
    children: new Array(loops).fill(true).map((_l, i) => {
      return /* @__PURE__ */ jsxs89(React127.Fragment, {
        children: [
          /* @__PURE__ */ jsx183(Flex, {}),
          i === loops - 1 ? null : /* @__PURE__ */ jsx183(LoopedIndicator, {})
        ]
      }, i);
    })
  });
...
import { useEffect as useEffect60, useRef as useRef33, useState as useState58 } from "react";
...
var TimelineVideoInfo = ({ src }) => {
  ...
  const [videoMetadata, setVideoMetadata] = useState58(null);
  useEffect60(() => {
...
var TimelineSequence = ({ s }) => {
  ...
  return /* @__PURE__ */ jsx186(Inner4, {
    windowWidth,
    s
  });
};
var Inner4 = ({ s, windowWidth }) => {
  const [maxMediaDuration, setMaxMediaDuration] = useState59(Infinity);
  ...
  const { marginLeft, width: width2, premountWidth } = useMemo100(() => {
  ...
  return /* @__PURE__ */ jsxs90("div", {
    ...
    title: s.displayName,
    children: [
      premountWidth ? /* @__PURE__ */ jsx186("div", {
        style: {
          width: premountWidth,
          height: "100%",
...
\t\t\t\t\t\t)`,
      ...
      s.type === "audio" ? /* @__PURE__ */ jsx186(AudioWaveform, {
        src: s.src,
      ...
      s.type === "video" ? /* @__PURE__ */ jsx186(TimelineVideoInfo, {
        src: s.src
      }) : null,
      s.loopDisplay === undefined ? null : /* @__PURE__ */ jsx186(LoopedTimelineIndicator, {
        loops: s.loopDisplay.numberOfTimes
      }),
      s.type !== "audio" && s.type !== "video" && s.loopDisplay === undefined && (isInRange || isPremounting) ? /* @__PURE__ */ jsx186("div", {
        style: {
        ...
        children: /* @__PURE__ */ jsx186(TimelineSequenceFrame, {
...
var TimelineTracks = ({ timeline, hasBeenCut }) => {
  const inner2 = useMemo101(() => {
    return {
      height: TIMELINE_LAYER_HEIGHT,
      marginBottom: TIMELINE_ITEM_BORDER_BOTTOM
    };
  }, []);
  const timelineStyle = useMemo101(() => {
    return {
      ...timelineContent,
      width: 100 + "%"
    };
  ...
  return /* @__PURE__ */ jsxs91("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs91("div", {
        style: content,
        children: [
          /* @__PURE__ */ jsx187(TimelineTimePadding, {}),
          timeline.map((track) => {
            ...
            return /* @__PURE__ */ jsx187("div", {
              style: inner2,
              children: /* @__PURE__ */ jsx187(TimelineSequence, {
                s: track.sequence
              })
            }, track.sequence.id);
          })
      ...
      hasBeenCut ? /* @__PURE__ */ jsx187(MaxTimelineTracksReached, {}) : null
    ]
  });
};
...
var Timeline = () => {
  ...
  return /* @__PURE__ */ jsx188("div", {
    ...
    children: /* @__PURE__ */ jsx188(TimelineWidthProvider, {
      children: /* @__PURE__ */ jsx188("div", {
        style: inner2,
        children: /* @__PURE__ */ jsxs92(SplitterContainer, {
          orientation: "vertical",
          defaultFlex: 0.2,
          ...
          minFlex: 0.15,
          children: [
            /* @__PURE__ */ jsx188(SplitterElement, {
              type: "flexer",
              sticky: /* @__PURE__ */ jsx188(TimelineTimePlaceholders, {}),
              children: /* @__PURE__ */ jsx188(TimelineList, {
                timeline: shown
              })
            }),
            /* @__PURE__ */ jsx188(SplitterHandle, {
              onCollapse: noop2,
            ...
            /* @__PURE__ */ jsx188(SplitterElement, {
              type: "anti-flexer",
              sticky: null,
              children: /* @__PURE__ */ jsxs92(TimelineScrollable, {
                children: [
                  /* @__PURE__ */ jsx188(TimelineTracks, {
                    timeline: shown,
                    hasBeenCut
                  }),
                  /* @__PURE__ */ jsx188(TimelineInOutPointer, {}),
                  /* @__PURE__ */ jsx188(TimelinePlayCursorSyncer, {}),
                  /* @__PURE__ */ jsx188(TimelineDragHandler, {}),
                  /* @__PURE__ */ jsx188(TimelineTimeIndicators, {}),
                  /* @__PURE__ */ jsx188(TimelineSlider, {})
                ]
              })
            })
          ]
...
// src/components/EditorContent.tsx
import { jsx as jsx189, jsxs as jsxs93, Fragment as Fragment27 } from "react/jsx-runtime";
var noop3 = () => {
  return;
};
var container41 = {
...
var EditorContent = ({ readOnlyStudio, children }) => {
  ...
  return /* @__PURE__ */ jsxs93("div", {
    style: container41,
    children: [
      /* @__PURE__ */ jsx189(InitialCompositionLoader, {}),
      /* @__PURE__ */ jsx189(MenuToolbar, {
        readOnlyStudio
      }),
      /* @__PURE__ */ jsxs93(SplitterContainer, {
        orientation: "horizontal",
        id: "top-to-bottom",
        maxFlex: 0.9,
        minFlex: 0.2,
        defaultFlex: 0.75,
        children: [
          /* @__PURE__ */ jsx189(SplitterElement, {
            sticky: null,
            type: "flexer",
            children
          }),
          onlyTopPanel ? null : /* @__PURE__ */ jsxs93(Fragment27, {
            children: [
              /* @__PURE__ */ jsx189(SplitterHandle, {
                allowToCollapse: "none",
                onCollapse: noop3
              }),
              /* @__PURE__ */ jsx189(SplitterElement, {
                sticky: null,
                type: "anti-flexer",
                children: /* @__PURE__ */ jsx189(Timeline, {})
              })
            ]
          })
        ]
...
import React136, { useCallback as useCallback93, useContext as useContext68, useEffect as useEffect62 } from "react";
...
var InstallablePackageComp = ({ isInstalled, pkg, link, description }) => {
  return /* @__PURE__ */ jsxs94("div", {
    ...
    children: [
      ...
      " ",
      isInstalled ? /* @__PURE__ */ jsx190("span", {
        style: { opacity: 0.3, fontSize: "inherit" },
        children: "(installed)"
      }) : null,
      /* @__PURE__ */ jsx190("br", {}),
      /* @__PURE__ */ jsx190("span", {
...
import { useCallback as useCallback91, useContext as useContext66 } from "react";
...
var ModalContainer = ({ children, onEscape, onOutsideClick }) => {
  return /* @__PURE__ */ jsx194("div", {
    ...
    role: "dialog",
    "aria-modal": "true",
    children: /* @__PURE__ */ jsx194(HigherZIndex, {
      onOutsideClick,
      onEscape,
...
var DismissableModal = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx195(ModalContainer, {
...
// src/components/InstallPackage.tsx
import { jsx as jsx196, jsxs as jsxs96 } from "react/jsx-runtime";
var container43 = {
  padding: 20,
  maxHeight: 400,
  overflowY: "auto"
...
var InstallPackageModal = ({ packageManager }) => {
  const [state, setState] = React136.useState({ type: "idle" });
  const [map, setMap] = React136.useState({
  ...
  const onClick = useCallback93(async () => {
    if (state.type === "done") {
  ...
  return /* @__PURE__ */ jsxs96(DismissableModal, {
    children: [
      /* @__PURE__ */ jsx196(ModalHeader, {
        title: "Install packages"
      }),
      /* @__PURE__ */ jsx196("div", {
        style: container43,
        className: VERTICAL_SCROLLBAR_CLASSNAME,
        children: state.type === "done" ? /* @__PURE__ */ jsxs96("div", {
          style: text2,
          children: [
            "Installed package",
        ...
        }) : state.type === "restarting" ? /* @__PURE__ */ jsx196("div", {
          style: text2,
          children: "Restarting the Studio server..."
        }) : state.type === "installing" ? /* @__PURE__ */ jsxs96("div", {
          style: text2,
          children: [
            "Installing package",
            selectedPackages.length === 1 ? "" : "s",
          ...
          children: listOfInstallableRemotionPackages.map((pkg) => {
            ...
            return /* @__PURE__ */ jsxs96(Row, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx196(Spacing, {
                  x: 1.5
                }),
                /* @__PURE__ */ jsx196(InstallablePackageComp, {
                  description,
                  isInstalled,
                  link,
                  pkg
      ...
      /* @__PURE__ */ jsx196(ModalFooterContainer, {
        children: /* @__PURE__ */ jsxs96(Row, {
          align: "center",
          children: [
            state.type === "idle" ? /* @__PURE__ */ jsxs96("span", {
...
import { useCallback as useCallback95, useContext as useContext71, useMemo as useMemo105 } from "react";

// src/components/RenderModal/ResolveCompositionBeforeModal.tsx
import React137, { useContext as useContext69, useEffect as useEffect63, useMemo as useMemo104 } from "react";
...
var ResolvedCompositionContext = React137.createContext(null);
var ResolveCompositionBeforeModal = ({ compositionId, children }) => {
  ...
  if (!resolved || resolved.type === "loading") {
    return /* @__PURE__ */ jsx197(RunningCalculateMetadata, {});
  }
  if (resolved.type === "error") {
    return /* @__PURE__ */ jsxs97("div", {
      style: loaderContainer2,
      children: [
        /* @__PURE__ */ jsx197(Spacing, {
          y: 2
        }),
        /* @__PURE__ */ jsxs97("div", {
          style: loaderLabel2,
  ...
  return /* @__PURE__ */ jsx197(ResolvedCompositionContext.Provider, {
    value,
    children
  });
};
...
import { useCallback as useCallback94, useContext as useContext70, useEffect as useEffect64, useState as useState60 } from "react";
...
var CodemodFooter = ({
  ...
  const [projectInfo, setProjectInfo] = useState60(null);
  useEffect64(() => {
    const controller = new AbortController;
  ...
  const getCanApplyCodemod = useCallback94(async (signal) => {
  ...
  return /* @__PURE__ */ jsxs99(Row, {
    align: "center",
    children: [
      /* @__PURE__ */ jsx199(CodemodDiffPreview, {
...
// src/components/NewComposition/DeleteComposition.tsx
import { jsx as jsx200, jsxs as jsxs100, Fragment as Fragment28 } from "react/jsx-runtime";
var content3 = {
  padding: 16,
  fontSize: 14,
  flex: 1,
...
var DeleteCompositionLoaded = ({ compositionId }) => {
  ...
  return /* @__PURE__ */ jsxs100(Fragment28, {
    children: [
      /* @__PURE__ */ jsx200(ModalHeader, {
        title: "Delete composition"
      }),
      /* @__PURE__ */ jsxs100("form", {
        onSubmit,
        children: [
          ...
          /* @__PURE__ */ jsx200(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx200(CodemodFooter, {
...
var DeleteComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx200(DismissableModal, {
    children: /* @__PURE__ */ jsx200(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx200(DeleteCompositionLoaded, {
        compositionId
      })
    })
  });
...
import { useCallback as useCallback97, useContext as useContext72, useMemo as useMemo106, useState as useState61 } from "react";
...
import { jsx as jsx201, jsxs as jsxs101, Fragment as Fragment29 } from "react/jsx-runtime";
var NewCompDuration = ({ durationInFrames, setDurationInFrames }) => {
  const onDurationInFramesChanged = useCallback96((newValue) => {
    setDurationInFrames(Number(newValue));
  }, [setDurationInFrames]);
  const onDurationChangedDirectly = useCallback96((newVal) => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs101("div", {
        ...
        children: [
          ...
          compDurationErrMessage ? /* @__PURE__ */ jsxs101(Fragment29, {
            children: [
              /* @__PURE__ */ jsx201(Spacing, {
                y: 1,
                block: true
              }),
              /* @__PURE__ */ jsx201(ValidationMessage, {
                align: "flex-start",
...
// src/components/NewComposition/DuplicateComposition.tsx
import { jsx as jsx202, jsxs as jsxs102, Fragment as Fragment30 } from "react/jsx-runtime";
var content4 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var DuplicateCompositionLoaded = ({ initialType }) => {
  ...
  const [initialCompType] = useState61(initialType);
  ...
  const [size4, setSize] = useState61(() => ({
    width: resolved.result.width,
    height: resolved.result.height
  }));
  const [durationInFrames, setDurationInFrames] = useState61(resolved.result.durationInFrames);
  const onTypeChanged = useCallback97((newType) => {
    setType(newType);
  }, []);
  const onWidthChanged = useCallback97((newValue) => {
    setSize((s) => {
      const { height } = s;
  ...
  const onWidthDirectlyChanged = useCallback97((newWidth) => {
    setSize((s) => {
      const { height } = s;
      return {
        height,
  ...
  const onHeightDirectlyChanged = useCallback97((newHeight) => {
    setSize((s) => {
  ...
  const onHeightChanged = useCallback97((newValue) => {
    setSize((s) => {
      const { width: width2 } = s;
  ...
  const onNameChange = useCallback97((e) => {
    setName(e.target.value);
  }, []);
  const onTextFpsChange = useCallback97((newFps) => {
    setFrameRate(Number(newFps));
  }, []);
  const onFpsChange = useCallback97((newFps) => {
    setFrameRate(newFps);
  }, []);
  ...
  const onSubmit = useCallback97((e) => {
    e.preventDefault();
  }, []);
  return /* @__PURE__ */ jsxs102(Fragment30, {
    children: [
      /* @__PURE__ */ jsx202(ModalHeader, {
        title: `Duplicate ${resolved.result.id}`
      }),
      /* @__PURE__ */ jsxs102("form", {
        onSubmit,
        children: [
          /* @__PURE__ */ jsxs102("div", {
            style: content4,
            children: [
              initialCompType === "composition" ? /* @__PURE__ */ jsxs102("div", {
                style: optionRow,
                children: [
                  /* @__PURE__ */ jsx202("div", {
                    style: label5,
                  ...
                  /* @__PURE__ */ jsx202("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx202(Combobox, {
                  ...
                  /* @__PURE__ */ jsx202("div", {
                    ...
                    children: /* @__PURE__ */ jsxs102("div", {
                      children: [
                        ...
                        compNameErrMessage ? /* @__PURE__ */ jsxs102(Fragment30, {
                          children: [
                            /* @__PURE__ */ jsx202(Spacing, {
                              y: 1,
                              block: true
                            }),
                            /* @__PURE__ */ jsx202(ValidationMessage, {
                              align: "flex-start",
              ...
              hadDimensionsDefined ? /* @__PURE__ */ jsxs102(Fragment30, {
                children: [
                  /* @__PURE__ */ jsxs102("div", {
                    style: optionRow,
                    children: [
                      ...
                      /* @__PURE__ */ jsxs102("div", {
                        ...
                        children: [
                          ...
                          compWidthErrMessage ? /* @__PURE__ */ jsxs102(Fragment30, {
                            children: [
                              /* @__PURE__ */ jsx202(Spacing, {
                                y: 1,
                                block: true
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxs102("div", {
                        ...
                        children: [
                          ...
                          compHeightErrMessage ? /* @__PURE__ */ jsxs102(Fragment30, {
                            children: [
                              /* @__PURE__ */ jsx202(Spacing, {
                                y: 1,
                                block: true
              ...
              type === "composition" && hadDurationDefined ? /* @__PURE__ */ jsx202(NewCompDuration, {
                durationInFrames,
                setDurationInFrames
              }) : null,
              type === "composition" && hadFpsDefined ? /* @__PURE__ */ jsxs102("div", {
                style: optionRow,
                children: [
                  /* @__PURE__ */ jsx202("div", {
                    style: label5,
                  ...
                  /* @__PURE__ */ jsx202("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx202(InputDragger, {
                      type: "number",
...
var DuplicateComposition = ({ compositionId, compositionType }) => {
  return /* @__PURE__ */ jsx202(DismissableModal, {
    children: /* @__PURE__ */ jsx202(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx202(DuplicateCompositionLoaded, {
...
import { useCallback as useCallback98, useContext as useContext73, useMemo as useMemo107, useState as useState62 } from "react";
import { Internals as Internals56 } from "remotion";
import { jsx as jsx203, jsxs as jsxs103, Fragment as Fragment31 } from "react/jsx-runtime";
var content5 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var RenameCompositionLoaded = () => {
  ...
  return /* @__PURE__ */ jsxs103(Fragment31, {
    children: [
      /* @__PURE__ */ jsx203(ModalHeader, {
      ...
      /* @__PURE__ */ jsxs103("form", {
        ...
        children: [
                ...
                /* @__PURE__ */ jsx203("div", {
                  ...
                  children: /* @__PURE__ */ jsxs103("div", {
                    children: [
                      ...
                      compNameErrMessage ? /* @__PURE__ */ jsxs103(Fragment31, {
                        children: [
          ...
          /* @__PURE__ */ jsx203(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx203(CodemodFooter, {
...
var RenameComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx203(DismissableModal, {
    children: /* @__PURE__ */ jsx203(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx203(RenameCompositionLoaded, {})
    })
  });
};
...
var ShiftIcon = () => {
  return /* @__PURE__ */ jsx204("svg", {
    style: iconStyle5,
    viewBox: "0 0 448 512",
    children: /* @__PURE__ */ jsx204("path", {
      fill: "currentColor",
...
var KeyboardShortcutsExplainer = () => {
  return /* @__PURE__ */ jsxs104("div", {
    children: [
      areKeyboardShortcutsDisabled() ? /* @__PURE__ */ jsxs104("div", {
      ...
      /* @__PURE__ */ jsxs104(Row, {
        style: container44,
        children: [
          /* @__PURE__ */ jsxs104(Column, {
            children: [
              /* @__PURE__ */ jsx205("div", {
                style: title4,
                children: "Playback"
                ...
                children: [
                  /* @__PURE__ */ jsxs104("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx205("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx205(ShiftIcon, {})
                      }),
                      ...
                      /* @__PURE__ */ jsx205("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx205(ArrowLeft, {})
                      })
                    ]
                  }),
                  /* @__PURE__ */ jsx205("div", {
              ...
              /* @__PURE__ */ jsxs104(Row, {
                ...
                children: [
                  /* @__PURE__ */ jsx205("div", {
                    ...
                    children: /* @__PURE__ */ jsx205("kbd", {
                      style: key4,
                      children: /* @__PURE__ */ jsx205(ArrowRight, {})
                    })
                  }),
                  /* @__PURE__ */ jsx205("div", {
                    style: right2,
...
import { jsxs as jsxs105 } from "react/jsx-runtime";
var container45 = {
  padding: 80,
  color: LIGHT_TEXT,
  textAlign: "center",
...
import { useEffect as useEffect65, useMemo as useMemo108, useRef as useRef34, useState as useState63 } from "react";
import { jsx as jsx207, jsxs as jsxs106, Fragment as Fragment32 } from "react/jsx-runtime";
var container46 = {
  paddingLeft: 16,
  paddingRight: 16,
  display: "flex",
...
var QuickSwitcherResult = ({ result, selected }) => {
  const [hovered, setIsHovered] = useState63(false);
  ...
  return /* @__PURE__ */ jsxs106("div", {
    ...
    children: [
      result.type === "composition" ? result.compositionType === "still" ? /* @__PURE__ */ jsx207(StillIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : /* @__PURE__ */ jsx207(FilmIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : null,
      ...
      /* @__PURE__ */ jsx207("div", {
        ...
        children: result.type === "search-result" ? /* @__PURE__ */ jsxs106(Fragment32, {
          children: [
            /* @__PURE__ */ jsx207("div", {
...
// src/components/QuickSwitcher/QuickSwitcherContent.tsx
import { jsx as jsx208, jsxs as jsxs107, Fragment as Fragment33 } from "react/jsx-runtime";
var input2 = {
  width: "100%"
};
var modeSelector = {
...
var QuickSwitcherContent = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  ...
  const onArrowDown = useCallback99(() => {
    setState((s) => {
      return {
        ...s,
  ...
  const onTextChange = useCallback99((e) => {
  ...
  const onActionsSelected = useCallback99(() => {
    setState((s) => ({
  ...
  const onCompositionsSelected = useCallback99(() => {
    setState((s) => ({
      query: stripQuery(s.query),
      selectedIndex: 0
    }));
  ...
  const onDocSearchSelected = useCallback99(() => {
    setState((s) => ({
      query: `? ${stripQuery(s.query)}`,
      selectedIndex: 0
    }));
  ...
  const container47 = useMemo109(() => {
    return {
      width: showKeyboardShortcuts ? 800 : 500
    };
  }, [showKeyboardShortcuts]);
  const results = useMemo109(() => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs107("div", {
        ...
        children: [
          ...
          showKeyboardShortcuts ? /* @__PURE__ */ jsxs107(Fragment33, {
            children: [
              /* @__PURE__ */ jsx208(Spacing, {
                x: 2
              }),
              " ",
              /* @__PURE__ */ jsx208(AlgoliaCredit, {})
            ]
          }) : null
        ]
      }),
      /* @__PURE__ */ jsx208("div", {
        style: results,
        className: VERTICAL_SCROLLBAR_CLASSNAME,
        children: showKeyboardShortcuts ? /* @__PURE__ */ jsx208(KeyboardShortcutsExplainer, {}) : showSearchLoadingState ? null : resultsArray.length === 0 ? /* @__PURE__ */ jsx208(QuickSwitcherNoResults, {
          mode,
          query: actualQuery
        }) : resultsArray.map((result, i) => {
          return /* @__PURE__ */ jsx208(QuickSwitcherResult, {
...
var QuickSwitcher = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx209(DismissableModal, {
    children: /* @__PURE__ */ jsx209(QuickSwitcherContent, {
      readOnlyStudio,
      invocationTimestamp,
      initialMode
    })
...
import { useMemo as useMemo110, useState as useState65 } from "react";
var useRenderModalSections = (renderMode, codec) => {
  const [selectedTab, setTab] = useState65("general");
  const shownTabs = useMemo110(() => {
    if (renderMode === "audio") {
...
var AudioIcon = (props) => /* @__PURE__ */ jsx210("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var PicIcon = (props) => /* @__PURE__ */ jsx212("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GearIcon = (props) => /* @__PURE__ */ jsx213("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GifIcon = (props) => /* @__PURE__ */ jsx214("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 576 512",
  ...props,
...
import { useCallback as useCallback100, useMemo as useMemo111, useState as useState66 } from "react";
...
var VerticalTab = ({ children, onClick, style: style11, selected }) => {
  ...
  const { tabIndex } = useZIndex();
  const onPointerEnter = useCallback100(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback100(() => {
    setHovered(false);
  }, []);
  const definiteStyle = useMemo111(() => {
    return {
      ...selectorButton2,
...
import { useCallback as useCallback101, useEffect as useEffect67, useMemo as useMemo112, useState as useState67 } from "react";
...
var CliCopyButton = ({
  ...
  const fillColor = useMemo112(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const clipboardIcon = /* @__PURE__ */ jsx216(ClipboardIcon, {
    color: fillColor,
    style: svgStyle3
  });
  const checkSvg = /* @__PURE__ */ jsx216("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    style: svgStyle3,
  ...
  return copied ? /* @__PURE__ */ jsx216("span", {
    style: copiedStyle,
    children: checkSvg
  }) : /* @__PURE__ */ jsx216("button", {
    type: "button",
    onPointerEnter,
    onPointerLeave,
    style: buttonStyle6,
...
import { jsx as jsx217, jsxs as jsxs108 } from "react/jsx-runtime";
var container47 = {
  fontSize: 14,
  paddingTop: 10,
  paddingBottom: 10,
        ...
        children: [
          /* @__PURE__ */ jsxs108("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx217("div", {
                style: copyWrapper,
                children: /* @__PURE__ */ jsx217(CliCopyButton, {
                  valueToCopy: option.cliFlag
                })
              })
            ]
          }),
          option.ssrName ? /* @__PURE__ */ jsxs108("div", {
            style: infoRow,
            children: [
              /* @__PURE__ */ jsx217("div", {
                style: infoRowLabel,
...
var OptionExplainerBubble = ({ id }) => {
  ...
  return /* @__PURE__ */ jsx218(InfoBubble, {
    title: "Learn more about this option",
    children: /* @__PURE__ */ jsx218(OptionExplainer, {
      option
    })
  });
};
...
// src/components/RenderModal/NumberSetting.tsx
import { jsx as jsx219, jsxs as jsxs109, Fragment as Fragment34 } from "react/jsx-runtime";
var NumberSetting = ({ name, value, step, hint, onValueChanged, max, min, formatter }) => {
  const onTextChanged = useCallback102((e) => {
    onValueChanged((q) => {
  ...
  const onValueChange = useCallback102((newConcurrency) => {
  ...
  return /* @__PURE__ */ jsxs109("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs109("div", {
        ...
        children: [
          name,
          hint ? /* @__PURE__ */ jsxs109(Fragment34, {
            children: [
              /* @__PURE__ */ jsx219(Spacing, {
                x: 0.5
              }),
              /* @__PURE__ */ jsx219(OptionExplainerBubble, {
                id: hint
              })
            ]
          }) : null
      ...
      /* @__PURE__ */ jsx219("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx219(RightAlignInput, {
          children: /* @__PURE__ */ jsx219(InputDragger, {
            value,
...
var useCrfState = (codec) => {
  const [state, setState] = useState68(() => getDefaultCrfState());
...
var CrfSetting = ({ crf, setCrf, min, max, option }) => {
  return /* @__PURE__ */ jsx220(NumberSetting, {
    min,
    max,
    name: "CRF",
...
import { useCallback as useCallback106, useMemo as useMemo113 } from "react";
...
import React147, { useCallback as useCallback104 } from "react";
...
var InlineEyeButton = ({ onClick, enabled }) => {
  const renderAction = useCallback103((color) => {
    return enabled ? /* @__PURE__ */ jsx221("svg", {
      style: clearIcon2,
      viewBox: "0 0 640 512",
  ...
  return /* @__PURE__ */ jsx221(InlineAction, {
    renderAction,
    onClick
  });
};
...
// src/components/RenderModal/EnvInput.tsx
import { jsx as jsx222, jsxs as jsxs110, Fragment as Fragment35 } from "react/jsx-runtime";
var input3 = {
  flex: 1,
  width: "100%"
};
...
var EnvInput = ({
  ...
  const [showInPlainText, setShowInPlainText] = React147.useState(false);
  const [initialWarningKeyMissing, setKeyWarningEligible] = React147.useState(() => {
    return envKey.trim() === "" && envVal.trim() !== "";
  });
  const [initialWarningValMissing, setValueWarningEligible] = React147.useState(() => {
    return envKey.trim() !== "" && envVal.trim() === "";
  });
  ...
  const handleDelete = useCallback104(() => {
    onDelete(index);
  }, [index, onDelete]);
  const togglePlainText = useCallback104(() => {
    setShowInPlainText((prev) => !prev);
  }, []);
  const handleKeyChange = useCallback104((e) => {
    onEnvKeyChange(index, e.target.value);
  }, [index, onEnvKeyChange]);
  const handleValueChange = useCallback104((e) => {
    onEnvValChange(index, e.target.value);
  }, [index, onEnvValChange]);
  const makeKeyWarningEligible = useCallback104(() => {
    setKeyWarningEligible(true);
  }, []);
  const makeValueWarningEligible = useCallback104(() => {
    setValueWarningEligible(true);
  }, []);
  const isNodeEnvKey = envKey.trim() === "NODE_ENV";
  return /* @__PURE__ */ jsxs110(Fragment35, {
    children: [
      /* @__PURE__ */ jsxs110(Row, {
        align: "center",
        style: optionRow,
        children: [
          ...
          /* @__PURE__ */ jsx222(InlineEyeButton, {
            enabled: !showInPlainText,
            onClick: togglePlainText
          }),
          /* @__PURE__ */ jsx222(InlineRemoveButton, {
            onClick: handleDelete
          })
        ]
      }),
      isNodeEnvKey ? /* @__PURE__ */ jsx222("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx222(ValidationMessage, {
          align: "flex-start",
          type: "warning",
          message: "NODE_ENV will be overwritten by Remotion during the render process."
        })
      }) : null,
      isDuplicate ? /* @__PURE__ */ jsx222("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx222(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isKeyMissing ? /* @__PURE__ */ jsx222("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx222(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isValMissing ? /* @__PURE__ */ jsx222("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx222(ValidationMessage, {
          align: "flex-start",
          type: "warning",
...
// src/components/RenderModal/RenderModalEnvironmentVariables.tsx
import { jsx as jsx223, jsxs as jsxs111 } from "react/jsx-runtime";
var title6 = {
  fontSize: 14,
  fontWeight: "bold",
  color: LIGHT_TEXT,
...
var RenderModalEnvironmentVariables = ({ envVariables, setEnvVariables }) => {
  const onEnvValChange = useCallback105((index, value) => {
  ...
  const onEnvKeyChange = useCallback105((index, value) => {
    setEnvVariables((oldEnv) => {
      const newEnv = [...oldEnv];
  ...
  const onDelete = useCallback105((index) => {
    setEnvVariables((oldEnv) => oldEnv.filter((_, idx) => idx !== index));
  }, [setEnvVariables]);
  const addField = useCallback105(() => {
  ...
  return /* @__PURE__ */ jsxs111("div", {
    ...
    children: [
      ...
      envVariables.map((env, i) => {
        ...
        return /* @__PURE__ */ jsx223(EnvInput, {
          onEnvKeyChange,
          onEnvValChange,
          envKey: env[0],
          envVal: env[1],
      ...
      /* @__PURE__ */ jsx223(Spacing, {
        y: 1,
        block: true
      }),
      /* @__PURE__ */ jsx223(Button, {
        style: button4,
        onClick: addField,
...
var RenderModalAdvanced = ({
  ...
  const extendedOpenGlOptions = useMemo113(() => {
    return [
      "angle",
      "egl",
      "swangle",
  ...
  const toggleCustomOffthreadVideoCacheSizeInBytes = useCallback106(() => {
  ...
  const toggleCustomUserAgent = useCallback106(() => {
  ...
  const onDisallowParallelEncodingChanged = useCallback106((e) => {
    setDisallowParallelEncoding(e.target.checked);
  }, [setDisallowParallelEncoding]);
  const onDisableWebSecurityChanged = useCallback106((e) => {
    setDisableWebSecurity(e.target.checked);
  }, [setDisableWebSecurity]);
  const onEnableMultiProcessOnLinux = useCallback106((e) => {
    setChromiumMultiProcessOnLinux(e.target.checked);
  }, [setChromiumMultiProcessOnLinux]);
  const onIgnoreCertificatErrors = useCallback106((e) => {
    setIgnoreCertificateErrors(e.target.checked);
  }, [setIgnoreCertificateErrors]);
  const onHeadless = useCallback106((e) => {
    setHeadless(e.target.checked);
  }, [setHeadless]);
  const onUserAgentChanged = useCallback106((e) => {
    setUserAgent(e.target.value);
  }, [setUserAgent]);
  const onPlayBeepSound = useCallback106((e) => {
    setBeep(e.target.checked);
  }, [setBeep]);
  const onReproToggle = useCallback106((e) => {
    setRepro(e.target.checked);
  }, [setRepro]);
  const openGlOptions = useMemo113(() => {
    return extendedOpenGlOptions.map((option) => {
      return {
        label: option === "default" ? "Default" : option,
        onClick: () => setOpenGlOption(option),
        key: option,
        leftItem: openGlOption === option ? /* @__PURE__ */ jsx225(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const x264PresetOptions = useMemo113(() => {
    return BrowserSafeApis3.x264PresetOptions.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: x264Preset === option ? /* @__PURE__ */ jsx225(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        value: option
      };
  ...
  const hardwareAccelerationValues = useMemo113(() => {
    return BrowserSafeApis3.hardwareAccelerationOptions.map((option) => {
      return {
        label: option,
        onClick: () => setHardwareAcceleration(option),
        leftItem: hardwareAcceleration === option ? /* @__PURE__ */ jsx225(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null,
        type: "item",
        id: option,
  ...
  const changeOffthreadVideoCacheSizeInBytes = useCallback106((cb) => {
  ...
  return /* @__PURE__ */ jsxs112("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: [
      renderMode === "still" ? null : /* @__PURE__ */ jsx225(NumberSetting, {
        min: minConcurrency,
        max: maxConcurrency,
        step: 1,
        name: "Concurrency",
      ...
      renderMode === "video" && codec === "h264" ? /* @__PURE__ */ jsxs112("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsxs112("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx225(OptionExplainerBubble, {
                id: "x264Option"
              })
            ]
          }),
          /* @__PURE__ */ jsx225("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx225(Combobox, {
              title: x264Preset,
      ...
      renderMode === "video" ? /* @__PURE__ */ jsxs112("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsxs112("div", {
            style: label5,
      ...
      /* @__PURE__ */ jsxs112("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx225("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx225(Checkbox, {
      ...
      renderMode === "audio" ? null : /* @__PURE__ */ jsxs112("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx225("div", {
            style: label5,
      ...
      renderMode === "audio" || offthreadVideoCacheSizeInBytes === null ? null : /* @__PURE__ */ jsx225(NumberSetting, {
        min: minConcurrency,
        max: 2000 * 1024 * 1024,
        step: 1024,
      ...
      userAgent === null ? null : /* @__PURE__ */ jsxs112("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx225("div", {
            style: label5,
          ...
          /* @__PURE__ */ jsx225("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx225("div", {
              children: /* @__PURE__ */ jsx225(RemotionInput, {
                style: input,
                value: userAgent,
      ...
      /* @__PURE__ */ jsx225(RenderModalHr, {}),
      /* @__PURE__ */ jsx225(RenderModalEnvironmentVariables, {
        envVariables,
        setEnvVariables
      })
    ]
...
import { jsx as jsx226, jsxs as jsxs113 } from "react/jsx-runtime";
var EnforceAudioTrackSetting = ({ enforceAudioTrack, muted, setEnforceAudioTrack }) => {
  const onEnforceAudioTrackChanged = useCallback107((e) => {
    ...
    children: [
      /* @__PURE__ */ jsxs113("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx226(OptionExplainerBubble, {
      ...
      /* @__PURE__ */ jsx226("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx226(Checkbox, {
...
import { jsx as jsx227, jsxs as jsxs114 } from "react/jsx-runtime";
var MutedSetting = ({ muted, setMuted, enforceAudioTrack }) => {
  const onMutedChanged = useCallback108((e) => {
...
import { useCallback as useCallback109, useMemo as useMemo114 } from "react";

// src/helpers/use-file-existence.ts
import { useContext as useContext75, useEffect as useEffect68, useRef as useRef36, useState as useState69 } from "react";
...
import { jsx as jsx228, jsxs as jsxs115, Fragment as Fragment36 } from "react/jsx-runtime";
var RenderModalOutputName = ({
  ...
  return /* @__PURE__ */ jsxs115("div", {
    style: optionRow,
    children: [
      /* @__PURE__ */ jsx228(Column, {
        children: /* @__PURE__ */ jsx228("div", {
          style: label5,
          children: labelText
        })
      }),
      /* @__PURE__ */ jsx228("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsxs115("div", {
          children: [
            /* @__PURE__ */ jsx228(RemotionInput, {
            ...
            validationMessage ? /* @__PURE__ */ jsxs115(Fragment36, {
              children: [
                /* @__PURE__ */ jsx228(Spacing, {
                  y: 1,
                  block: true
                }),
                /* @__PURE__ */ jsx228(ValidationMessage, {
                  align: "flex-end",
                  message: validationMessage,
                  type: "error"
                })
              ]
            }) : existence ? /* @__PURE__ */ jsxs115(Fragment36, {
              children: [
                /* @__PURE__ */ jsx228(Spacing, {
                  y: 1,
                  block: true
...
// src/components/RenderModal/SeparateAudioOption.tsx
import { jsx as jsx229, jsxs as jsxs116, Fragment as Fragment37 } from "react/jsx-runtime";
var SeparateAudioOptionInput = ({ separateAudioTo, setSeparateAudioTo, audioCodec }) => {
  ...
  const onValueChange = useCallback109((e) => {
    setSeparateAudioTo(e.target.value);
  }, [setSeparateAudioTo]);
  const validationMessage = useMemo114(() => {
  ...
  return /* @__PURE__ */ jsx229(RenderModalOutputName, {
    existence,
    inputStyle: input,
    onValueChange,
...
var SeparateAudioOption = ({ separateAudioTo, setSeparateAudioTo, audioCodec, outName }) => {
  const onSeparateAudioChange = useCallback109((e) => {
    if (e.target.checked) {
  ...
  return /* @__PURE__ */ jsxs116(Fragment37, {
    children: [
      ...
      separateAudioTo === null ? null : /* @__PURE__ */ jsx229(SeparateAudioOptionInput, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec
      })
...
// src/components/RenderModal/RenderModalAudio.tsx
import { jsx as jsx230, jsxs as jsxs117, Fragment as Fragment38 } from "react/jsx-runtime";
var container50 = {
  flex: 1,
  overflowY: "auto"
};
var RenderModalAudio = ({
  ...
  const onShouldHaveTargetAudioBitrateChanged = useCallback110((e) => {
    setShouldHaveCustomTargetAudioBitrate(e.target.checked);
  }, [setShouldHaveCustomTargetAudioBitrate]);
  const onTargetAudioBitrateChanged = useCallback110((e) => {
    setCustomTargetAudioBitrateValue(e.target.value);
  }, [setCustomTargetAudioBitrateValue]);
  const onSeamlessAacConcatenationChanges = useCallback110((e) => {
    setForSeamlessAacConcatenation(e.target.checked);
  }, [setForSeamlessAacConcatenation]);
  const audioCodecOptions = useCallback110((currentCodec) => {
    return BrowserSafeApis5.supportedAudioCodecs[currentCodec].map((audioCodecOption) => {
      return {
        ...
        leftItem: codec === audioCodecOption ? /* @__PURE__ */ jsx230(Checkmark, {}) : null,
        id: audioCodecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  return /* @__PURE__ */ jsxs117("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs117(Fragment38, {
        children: [
          /* @__PURE__ */ jsx230(MutedSetting, {
            enforceAudioTrack,
            muted,
            setMuted
          }),
          /* @__PURE__ */ jsx230(RenderModalHr, {})
        ]
      }) : null,
      renderMode === "video" && audioCodecOptions(codec).length >= 2 && !muted ? /* @__PURE__ */ jsxs117("div", {
        style: optionRow,
        children: [
          ...
          /* @__PURE__ */ jsx230("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx230(Combobox, {
      ...
      (renderMode === "video" || renderMode === "audio") && !muted && /* @__PURE__ */ jsxs117(Fragment38, {
        children: [
          /* @__PURE__ */ jsx230(EnforceAudioTrackSetting, {
            muted,
            enforceAudioTrack,
      ...
      renderMode === "video" && !muted ? /* @__PURE__ */ jsx230(SeparateAudioOption, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec,
        outName
      }) : null,
      audioCodec === "aac" && !muted ? /* @__PURE__ */ jsxs117("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsxs117("div", {
            style: label5,
          ...
          /* @__PURE__ */ jsx230("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx230(Checkbox, {
              disabled: false,
      ...
      renderMode === "still" || muted ? null : /* @__PURE__ */ jsxs117("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsxs117("div", {
            style: label5,
      ...
      shouldHaveCustomTargetAudioBitrate && renderMode !== "still" && !muted ? /* @__PURE__ */ jsxs117("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx230("div", {
            style: label5,
          ...
          /* @__PURE__ */ jsx230("div", {
            ...
            children: /* @__PURE__ */ jsx230("div", {
              children: /* @__PURE__ */ jsx230(RemotionInput, {
                style: input,
...
import { useCallback as useCallback113, useMemo as useMemo116 } from "react";
...
import { useCallback as useCallback111, useMemo as useMemo115 } from "react";
import { jsx as jsx231, jsxs as jsxs118 } from "react/jsx-runtime";
var container51 = {
  borderColor: "black",
  borderStyle: "solid",
  borderWidth: "2px",
...
var MultiRangeSlider = ({
  ...
  const getPercent = useCallback111((value) => Math.round((value - min) / (max - min) * 100), [min, max]);
  const rangeStyle = useMemo115(() => {
  ...
  const onChangeLeft = useCallback111((event) => {
    const value = Math.min(Number(event.target.value), end - 1);
    onLeftThumbDrag(value);
  }, [end, onLeftThumbDrag]);
  const onChangeRight = useCallback111((event) => {
...
// src/components/RenderModal/FrameRangeSetting.tsx
import { jsx as jsx232, jsxs as jsxs119 } from "react/jsx-runtime";
var numberWrapper = {
  minWidth: "39px",
  display: "flex",
  justifyContent: "flex-end",
...
var FrameRangeSetting = ({ startFrame, endFrame, setEndFrame, durationInFrames, setStartFrame }) => {
  ...
  const onStartFrameChangedDirectly = useCallback112((newStartFrame) => {
    setStartFrame(newStartFrame);
  }, [setStartFrame]);
  const onEndFrameChangedDirectly = useCallback112((newEndFrame) => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs119("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx232(MultiRangeSlider, {
            min: minStartFrame,
            max: maxEndFrame,
            start: startFrame,
            end: endFrame,
...
// src/components/RenderModal/RenderModalBasic.tsx
import { jsx as jsx233, jsxs as jsxs120 } from "react/jsx-runtime";
var container52 = {
  flex: 1
};
var RenderModalBasic = ({
  ...
  const videoCodecOptions = useMemo116(() => {
    return BrowserSafeApis6.validCodecs.filter((c) => {
      ...
      return {
        ...
        key: codecOption,
        leftItem: codec === codecOption ? /* @__PURE__ */ jsx233(Checkmark, {}) : null,
        id: codecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const proResProfileOptions = useMemo116(() => {
  ...
  const onFrameSetDirectly = useCallback113((newFrame) => {
    setFrame(newFrame);
  }, [setFrame]);
  const onFrameChanged = useCallback113((e) => {
    setFrame((q) => {
  ...
  const onValueChange = useCallback113((e) => {
    setOutName(e.target.value);
  }, [setOutName]);
  const onVerboseLoggingChanged = useCallback113((e) => {
    setVerboseLogging(e.target.checked ? "verbose" : "info");
  }, [setVerboseLogging]);
  return /* @__PURE__ */ jsxs120("div", {
    style: container52,
    children: [
      renderMode === "still" || renderMode === "sequence" ? /* @__PURE__ */ jsxs120("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx233("div", {
            style: label5,
          ...
          /* @__PURE__ */ jsx233("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx233(SegmentedControl, {
        ...
        children: [
          /* @__PURE__ */ jsxs120("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx233(OptionExplainerBubble, {
                id: "videoCodecOption"
              })
            ]
          }),
          /* @__PURE__ */ jsx233("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx233(Combobox, {
      ...
      renderMode === "still" && resolvedComposition.durationInFrames > 1 ? /* @__PURE__ */ jsxs120("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx233("div", {
            style: label5,
          ...
          /* @__PURE__ */ jsx233("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx233(RightAlignInput, {
              children: /* @__PURE__ */ jsx233(InputDragger, {
                value: frame2,
      ...
      renderMode === "video" && codec === "prores" ? /* @__PURE__ */ jsxs120("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx233("div", {
            style: label5,
      ...
      renderMode === "still" ? null : /* @__PURE__ */ jsx233(FrameRangeSetting, {
      ...
      /* @__PURE__ */ jsx233(RenderModalOutputName, {
        existence,
        inputStyle: input,
        outName,
        onValueChange,
      ...
      /* @__PURE__ */ jsxs120("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx233("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx233(Checkbox, {
...
var NumberOfLoopsSetting = ({ numberOfGifLoops, setNumberOfGifLoops }) => {
  const onNumberOfGifLoopsChangedDirectly = useCallback114((newConcurrency) => {
    setNumberOfGifLoops(newConcurrency);
  }, [setNumberOfGifLoops]);
  const onNumberOfGifLoopsChanged = useCallback114((e) => {
  ...
  return /* @__PURE__ */ jsxs121("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx234("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx234(RightAlignInput, {
...
var RenderModalGif = ({
  ...
  const onShouldLimitNumberOfGifLoops = useCallback115((e) => {
  ...
  return /* @__PURE__ */ jsxs122("div", {
    ...
    children: [
      ...
      limitNumberOfGifLoops ? /* @__PURE__ */ jsx235(NumberOfLoopsSetting, {
...
import { useCallback as useCallback116, useMemo as useMemo117 } from "react";
...
var JpegQualitySetting = ({ jpegQuality, setJpegQuality }) => {
  return /* @__PURE__ */ jsx236(NumberSetting, {
...
var ScaleSetting = ({ scale, setScale }) => {
  return /* @__PURE__ */ jsx237(NumberSetting, {
    min: MIN_SCALE,
    max: MAX_SCALE,
    step: 0.1,
    name: "Scale",
...
// src/components/RenderModal/RenderModalPicture.tsx
import { jsx as jsx238, jsxs as jsxs123, Fragment as Fragment39 } from "react/jsx-runtime";
...
var RenderModalPicture = ({
  ...
  const colorSpaceOptions = useMemo117(() => {
    return BrowserSafeApis7.validColorSpaces.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: colorSpace === option ? /* @__PURE__ */ jsx238(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  const qualityControlOptions = useMemo117(() => {
  ...
  const onTargetVideoBitrateChanged = useCallback116((e) => {
    setCustomTargetVideoBitrateValue(e.target.value);
  }, [setCustomTargetVideoBitrateValue]);
  const onEncodingBufferSizeToggled = useCallback116((e) => {
    setEncodingBufferSize(e.target.checked ? "10000k" : null);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateToggled = useCallback116((e) => {
    setEncodingMaxRate(e.target.checked ? "5000k" : null);
  }, [setEncodingMaxRate]);
  const onEncodingBufferSizeChanged = useCallback116((e) => {
    setEncodingBufferSize(e.target.value);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateChanged = useCallback116((e) => {
    ...
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs123("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx238("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx238(SegmentedControl, {
              items: imageFormatOptions,
              needsWrapping: false
            })
          })
      ...
      renderMode === "video" && videoImageFormat === "jpeg" && /* @__PURE__ */ jsx238(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "still" && stillImageFormat === "jpeg" && /* @__PURE__ */ jsx238(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "video" && qualityControlType !== null ? /* @__PURE__ */ jsx238(RenderModalHr, {}) : null,
      shouldDisplayQualityControlPicker && renderMode === "video" ? /* @__PURE__ */ jsxs123("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx238("div", {
            style: label5,
      ...
      qualityControlType === "crf" && renderMode !== "still" && renderMode !== "sequence" && crf !== null ? /* @__PURE__ */ jsx238(CrfSetting, {
        crf,
        min: minCrf,
        max: maxCrf,
        setCrf,
      ...
      qualityControlType === "bitrate" && renderMode === "video" ? /* @__PURE__ */ jsxs123("div", {
        style: optionRow,
        children: [
          ...
          /* @__PURE__ */ jsx238("div", {
            ...
            children: /* @__PURE__ */ jsx238("div", {
              children: /* @__PURE__ */ jsx238(RemotionInput, {
                style: input,
      ...
      renderMode === "video" ? /* @__PURE__ */ jsxs123(Fragment39, {
        children: [
          /* @__PURE__ */ jsxs123("div", {
            style: optionRow,
            children: [
          ...
          encodingBufferSize === null ? null : /* @__PURE__ */ jsxs123("div", {
            style: optionRow,
            children: [
              /* @__PURE__ */ jsx238("div", {
                style: label5,
          ...
          encodingMaxRate === null ? null : /* @__PURE__ */ jsxs123("div", {
            style: optionRow,
            children: [
              /* @__PURE__ */ jsx238("div", {
                style: label5,
      ...
      renderMode === "video" ? /* @__PURE__ */ jsx238(RenderModalHr, {}) : null,
      /* @__PURE__ */ jsx238(ScaleSetting, {
        scale,
        setScale
      }),
      renderMode === "video" ? /* @__PURE__ */ jsx238(RenderModalHr, {}) : null,
      renderMode === "video" ? /* @__PURE__ */ jsxs123("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx238("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx238(Combobox, {
...
// src/components/RenderModal/RenderModal.tsx
import { jsx as jsx239, jsxs as jsxs124 } from "react/jsx-runtime";
...
var RenderModal = ({
  ...
  const [unclampedFrame, setFrame] = useState70(() => initialFrame);
  const [saving, setSaving] = useState70(false);
  const [stillImageFormat, setStillImageFormat] = useState70(() => initialStillImageFormat);
  const [videoImageFormat, setVideoImageFormat] = useState70(() => initialVideoImageFormat);
  const [sequenceImageFormat, setSequenceImageFormat] = useState70(() => initialStillImageFormat === "jpeg" ? "jpeg" : "png");
  const [concurrency, setConcurrency] = useState70(() => initialConcurrency);
  const [videoCodecForVideoTab, setVideoCodecForVideoTab] = useState70(() => initialVideoCodecForVideoTab);
  const [userSelectedAudioCodec, setUserSelectedAudioCodec] = useState70(() => initialAudioCodec);
  const [separateAudioTo, setSeparateAudioTo] = useState70(null);
  const [envVariables, setEnvVariables] = useState70(() => envVariablesObjectToArray(initialEnvVariables).filter(([key5]) => key5 !== "NODE_ENV"));
  const [initialOutName] = useState70(() => {
  ...
  const [videoCodecForAudioTab, setVideoCodecForAudioTab] = useState70(() => initialVideoCodecForAudioTab);
  const [mutedState, setMuted] = useState70(() => initialMuted);
  const [repro, setRepro] = useState70(() => initialRepro);
  const [enforceAudioTrackState, setEnforceAudioTrackState] = useState70(() => initialEnforceAudioTrack);
  const [forSeamlessAacConcatenation, setForSeamlessAacConcatenation] = useState70(() => initialForSeamlessAacConcatenation);
  const [renderMode, setRenderModeState] = useState70(initialRenderType);
  const [jpegQuality, setJpegQuality] = useState70(() => initialJpegQuality);
  const [scale, setScale] = useState70(() => initialScale);
  const [logLevel, setLogLevel] = useState70(() => initialLogLevel);
  const [disallowParallelEncoding, setDisallowParallelEncoding] = useState70(false);
  const [disableWebSecurity, setDisableWebSecurity] = useState70(() => initialDisableWebSecurity);
  const [headless, setHeadless] = useState70(() => initialHeadless);
  const [beepOnFinish, setBeepOnFinish] = useState70(() => initialBeep);
  const [ignoreCertificateErrors, setIgnoreCertificateErrors] = useState70(() => initialIgnoreCertificateErrors);
  const [multiProcessOnLinux, setChromiumMultiProcessOnLinux] = useState70(() => initialMultiProcessOnLinux);
  const [openGlOption, setOpenGlOption] = useState70(() => initialGl ?? "default");
  const [colorSpace, setColorSpace] = useState70(() => initialColorSpace);
  const [userAgent, setUserAgent] = useState70(() => initialUserAgent === null ? null : initialUserAgent.trim() === "" ? null : initialUserAgent);
  const chromiumOptions = useMemo118(() => {
    return {
      headless,
      disableWebSecurity,
      ignoreCertificateErrors,
  ...
  const [outName, setOutName] = useState70(() => initialOutName);
  const [endFrameOrNull, setEndFrame] = useState70(() => outFrameMark ?? null);
  const [startFrameOrNull, setStartFrame] = useState70(() => inFrameMark ?? null);
  const [proResProfileSetting, setProResProfile] = useState70(() => initialProResProfile);
  const [x264PresetSetting, setx264Preset] = useState70(() => initialx264Preset);
  const [hardwareAcceleration, setHardwareAcceleration] = useState70(() => initialHardwareAcceleration);
  const [userPreferredPixelFormat, setPixelFormat] = useState70(() => initialPixelFormat);
  const [preferredQualityControlType, setQualityControl] = useState70(() => initialVideoBitrate === null ? "crf" : "bitrate");
  const [
    shouldHaveCustomTargetAudioBitrate,
    setShouldHaveCustomTargetAudioBitrate
  ] = useState70(() => initialAudioBitrate !== null);
  const [customTargetAudioBitrate, setCustomTargetAudioBitrateValue] = useState70(() => initialAudioBitrate ?? "320K");
  const [customTargetVideoBitrate, setCustomTargetVideoBitrateValue] = useState70(() => initialVideoBitrate ?? "1M");
  const [encodingMaxRate, setEncodingMaxRate] = useState70(() => initialEncodingMaxRate ?? null);
  const [encodingBufferSize, setEncodingBufferSize] = useState70(() => initialEncodingBufferSize ?? null);
  const [limitNumberOfGifLoops, setLimitNumberOfGifLoops] = useState70(() => initialNumberOfGifLoops !== null);
  const [numberOfGifLoopsSetting, setNumberOfGifLoopsSetting] = useState70(() => initialNumberOfGifLoops ?? 0);
  const [delayRenderTimeout, setDelayRenderTimeout] = useState70(() => initialDelayRenderTimeout);
  const [offthreadVideoCacheSizeInBytes, setOffthreadVideoCacheSizeInBytes] = useState70(initialOffthreadVideoCacheSizeInBytes);
  const codec = useMemo118(() => {
    if (renderMode === "audio") {
      return videoCodecForAudioTab;
    }
    return videoCodecForVideoTab;
  }, [videoCodecForAudioTab, renderMode, videoCodecForVideoTab]);
  const numberOfGifLoops = useMemo118(() => {
    if (codec === "gif" && limitNumberOfGifLoops) {
      return numberOfGifLoopsSetting;
    }
    return null;
  }, [codec, limitNumberOfGifLoops, numberOfGifLoopsSetting]);
  const audioBitrate = useMemo118(() => {
  ...
  const supportsBothQualityControls = useMemo118(() => {
    return supportsCrf && supportsVideoBitrate;
  }, [supportsCrf, supportsVideoBitrate]);
  const qualityControlType = useMemo118(() => {
  ...
  const dispatchIfMounted = useCallback117((payload) => {
    if (isMounted.current === false)
      return;
    dispatch(payload);
  }, []);
  const muted = useMemo118(() => {
    if (renderMode === "video") {
      return mutedState;
    }
    return false;
  }, [mutedState, renderMode]);
  const enforceAudioTrack = useMemo118(() => {
    if (renderMode === "video") {
  ...
  const deriveFinalAudioCodec = useCallback117((passedVideoCodec, passedAudioCodec) => {
  ...
  const setDefaultOutName = useCallback117((options) => {
  ...
  const setAudioCodec = useCallback117((newAudioCodec) => {
  ...
  const setCodec = useCallback117((newCodec) => {
    if (renderMode === "audio") {
  ...
  const setStillFormat = useCallback117((format) => {
  ...
  const onClickStill = useCallback117(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
  ...
  const everyNthFrame = useMemo118(() => {
    if (codec === "gif") {
  ...
  const availablePixelFormats = useMemo118(() => {
    return BrowserSafeApis10.validPixelFormatsForCodec(codec);
  }, [codec]);
  const pixelFormat = useMemo118(() => {
  ...
  const onClickVideo = useCallback117(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const onClickSequence = useCallback117(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const imageFormatOptions = useMemo118(() => {
    if (renderMode === "still") {
      return [
        {
          label: "PNG",
  ...
  const setRenderMode = useCallback117((newRenderMode) => {
  ...
  const renderTabOptions = useMemo118(() => {
  ...
  const pixelFormatOptions = useMemo118(() => {
    return availablePixelFormats.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: pixelFormat === option ? /* @__PURE__ */ jsx239(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  return /* @__PURE__ */ jsxs124("div", {
    style: outer4,
    children: [
      /* @__PURE__ */ jsx239(ModalHeader, {
        title: `Render ${resolvedComposition.id}`
      }),
      /* @__PURE__ */ jsxs124("div", {
        style: container55,
        children: [
          /* @__PURE__ */ jsx239(SegmentedControl, {
      ...
      /* @__PURE__ */ jsxs124("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs124("div", {
            style: leftSidebar,
            children: [
              shownTabs.includes("general") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                style: horizontalTab,
                ...
                children: [
                  /* @__PURE__ */ jsx239("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx239(FileIcon, {
                      style: icon6
                    })
                  }),
                  "General"
              ...
              shownTabs.includes("data") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                style: horizontalTab,
                selected: tab === "data",
                onClick: () => setTab("data"),
                children: [
                  /* @__PURE__ */ jsx239("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx239(DataIcon, {
                      style: icon6
                    })
                  }),
                  "Input Props"
              ...
              shownTabs.includes("picture") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                style: horizontalTab,
                ...
                children: [
                  /* @__PURE__ */ jsx239("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx239(PicIcon, {
                      style: icon6
                    })
                  }),
                  "Picture"
              ...
              shownTabs.includes("audio") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                style: horizontalTab,
                selected: tab === "audio",
                ...
                children: [
                  /* @__PURE__ */ jsx239("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx239(AudioIcon, {
                      style: icon6
                    })
                  }),
                  "Audio"
              ...
              shownTabs.includes("gif") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                style: horizontalTab,
                selected: tab === "gif",
                onClick: () => setTab("gif"),
                children: [
                  /* @__PURE__ */ jsx239("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx239(GifIcon, {
                      style: icon6
                    })
                  }),
                  "GIF"
              ...
              shownTabs.includes("advanced") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                style: horizontalTab,
                ...
                children: [
                  /* @__PURE__ */ jsx239("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx239(GearIcon, {
                      style: icon6
                    })
                  }),
                  "Other"
          ...
          /* @__PURE__ */ jsx239("div", {
            style: optionsPanel,
            className: VERTICAL_SCROLLBAR_CLASSNAME,
            children: tab === "general" ? /* @__PURE__ */ jsx239(RenderModalBasic, {
              codec,
              resolvedComposition,
              frame: frame2,
              imageFormatOptions,
            ...
            }) : tab === "picture" ? /* @__PURE__ */ jsx239(RenderModalPicture, {
              renderMode,
              scale,
              setScale,
              pixelFormat,
              ...
              encodingMaxRate,
              setEncodingMaxRate
            }) : tab === "audio" ? /* @__PURE__ */ jsx239(RenderModalAudio, {
              muted,
              renderMode,
              setMuted,
              codec,
              ...
              setSeparateAudioTo,
              outName
            }) : tab === "gif" ? /* @__PURE__ */ jsx239(RenderModalGif, {
              everyNthFrame,
              limitNumberOfGifLoops,
              numberOfGifLoopsSetting,
              setEveryNthFrameSetting,
              setLimitNumberOfGifLoops,
              setNumberOfGifLoopsSetting
            }) : tab === "data" ? /* @__PURE__ */ jsx239(DataEditor, {
            ...
            }) : /* @__PURE__ */ jsx239(RenderModalAdvanced, {
              x264Preset,
              setx264Preset,
              concurrency,
              maxConcurrency,
...
var RenderModalWithLoader = (props) => {
  return /* @__PURE__ */ jsx239(DismissableModal, {
    children: /* @__PURE__ */ jsx239(ResolveCompositionBeforeModal, {
      compositionId: props.compositionId,
      children: /* @__PURE__ */ jsx239(RenderModal, {
        ...props
      })
    })
  });
...
import { useCallback as useCallback119, useContext as useContext77 } from "react";

// src/components/RenderModal/GuiRenderStatus.tsx
import { useCallback as useCallback118, useMemo as useMemo119 } from "react";
...
var SuccessIcon = () => {
  return /* @__PURE__ */ jsx240("svg", {
    style: iconStyle7,
    viewBox: "0 0 512 512",
    children: /* @__PURE__ */ jsx240("path", {
      fill: LIGHT_TEXT,
      d: "M256 512c141.4 0 256-114.6 256-256S397.4 0 256 0S0 114.6 0 256S114.6 512 256 512zM369 209L241 337l-17 17-17-17-64-64-17-17L160 222.1l17 17 47 47L335 175l17-17L385.9 192l-17 17z"
    })
  });
...
var BundlingProgress = ({ progress, doneIn }) => {
  return /* @__PURE__ */ jsxs125("div", {
    style: progressItem,
    children: [
      progress === 1 ? /* @__PURE__ */ jsx241(SuccessIcon, {}) : /* @__PURE__ */ jsx241(CircularProgress, {
        progress
      }),
...
var RenderingProgress = ({ progress }) => {
  return /* @__PURE__ */ jsxs125("div", {
    style: progressItem,
    children: [
      progress.frames === progress.totalFrames ? /* @__PURE__ */ jsx241(SuccessIcon, {}) : /* @__PURE__ */ jsx241(CircularProgress, {
      ...
      progress.doneIn ? /* @__PURE__ */ jsxs125("div", {
        style: right3,
        children: [
          progress.doneIn,
          "ms"
...
var OpenFile = ({ job }) => {
  ...
  return /* @__PURE__ */ jsxs125("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx241("div", {
        style: right3,
        children: /* @__PURE__ */ jsx241(RenderQueueOpenInFinderItem, {
          job
        })
      })
    ]
...
var GuiRenderStatus = ({ job }) => {
  ...
  return /* @__PURE__ */ jsxs125("div", {
    children: [
      ...
      /* @__PURE__ */ jsx241(BundlingProgress, {
        progress: job.progress.bundling.progress,
        doneIn: job.progress.bundling.doneIn
      }),
      job.progress.rendering ? /* @__PURE__ */ jsx241(RenderingProgress, {
        progress: job.progress.rendering
      }) : null,
      job.progress.stitching ? /* @__PURE__ */ jsx241(StitchingProgress, {
        progress: job.progress.stitching
      }) : null,
      job.progress.downloads.length > 0 ? /* @__PURE__ */ jsx241(DownloadsProgress, {
        downloads: job.progress.downloads
      }) : null,
      job.status === "done" ? /* @__PURE__ */ jsx241(OpenFile, {
        job
      }) : null,
      /* @__PURE__ */ jsx241(Spacing, {
        y: 1
...
// src/components/RenderModal/RenderStatusModal.tsx
import { jsx as jsx242, jsxs as jsxs126, Fragment as Fragment40 } from "react/jsx-runtime";
var container56 = {
  padding: 20,
  maxWidth: 900,
  paddingTop: 0
...
var RenderStatusModal = ({
  ...
  const onQuit = useCallback119(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  const onRetry = useCallback119(() => {
    const retryPayload = makeRetryPayload(job);
    setSelectedModal(retryPayload);
  }, [job, setSelectedModal]);
  const onClickOnRemove = useCallback119(() => {
    setSelectedModal(null);
    removeRenderJob(job).catch((err) => {
      showNotification(`Could not remove job: ${err.message}`, 2000);
    });
  }, [job, setSelectedModal]);
  const onClickOnCancel = useCallback119(() => {
    cancelRenderJob(job).catch((err) => {
      showNotification(`Could not cancel job: ${err.message}`, 2000);
    });
  }, [job]);
  ...
  return /* @__PURE__ */ jsxs126(ModalContainer, {
    onOutsideClick: onQuit,
    onEscape: onQuit,
    children: [
      /* @__PURE__ */ jsx242(ModalHeader, {
        title: `Render ${job.compositionId}`
      }),
      /* @__PURE__ */ jsxs126("div", {
        style: container56,
        children: [
          job.status === "failed" ? /* @__PURE__ */ jsxs126(Fragment40, {
            children: [
              /* @__PURE__ */ jsx242("p", {
          ...
          job.status === "done" || job.status === "running" ? /* @__PURE__ */ jsx242(GuiRenderStatus, {
            job
          }) : null,
          /* @__PURE__ */ jsx242("div", {
            style: spacer3
          ...
          /* @__PURE__ */ jsxs126("div", {
            style: buttonRow,
            children: [
              job.status === "running" ? /* @__PURE__ */ jsx242(Button, {
                onClick: onClickOnCancel,
                children: "Cancel render"
              }) : /* @__PURE__ */ jsx242(Button, {
                onClick: onClickOnRemove,
                children: "Remove render"
              }),
              /* @__PURE__ */ jsx242(Flex, {}),
              job.status === "failed" ? /* @__PURE__ */ jsx242(Button, {
                onClick: onRetry,
                children: "Retry"
              }) : null,
              /* @__PURE__ */ jsx242("div", {
...
import { useCallback as useCallback122, useMemo as useMemo121 } from "react";

// src/components/CopyButton.tsx
import { useCallback as useCallback120, useEffect as useEffect70, useState as useState71 } from "react";
import { jsx as jsx243, jsxs as jsxs127 } from "react/jsx-runtime";
var iconStyle8 = {
  width: 16,
  height: 16,
  color: "white"
...
var copyIcon = /* @__PURE__ */ jsx243("svg", {
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "far",
  "data-icon": "clipboard",
...
var CopyButton = ({ textToCopy, label: label10, labelWhenCopied }) => {
  ...
  return /* @__PURE__ */ jsxs127(Button, {
    onClick,
    buttonContainerStyle,
    children: [
      copyIcon,
...
import { useCallback as useCallback121, useMemo as useMemo120, useState as useState72 } from "react";
...
var OpenIssueButton = ({ link: link3 }) => {
  ...
  const handleClick = useCallback121(() => {
    window.open(link3, "_blank");
  }, [link3]);
  const svgFillColor = useMemo120(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const openInEditorSvg = /* @__PURE__ */ jsx244("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle4,
    children: /* @__PURE__ */ jsx244("path", {
      fill: svgFillColor,
      d: "M320 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h82.7L201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L448 109.3V192c0 17.7 14.3 32 32 32s32-14.3 32-32V32c0-17.7-14.3-32-32-32H320zM80 32C35.8 32 0 67.8 0 112V432c0 44.2 35.8 80 80 80H400c44.2 0 80-35.8 80-80V320c0-17.7-14.3-32-32-32s-32 14.3-32 32V432c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16H192c17.7 0 32-14.3 32-32s-14.3-32-32-32H80z"
    })
  });
  const onPointerEnter = useCallback121(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback121(() => {
    setHovered(false);
  }, []);
  return /* @__PURE__ */ jsx244("button", {
    title: buttonTooltip,
    type: "button",
    onPointerEnter,
    onPointerLeave,
  ...
  const bugElements = bugs.map((bug) => {
    return /* @__PURE__ */ jsxs128("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx245(OpenIssueButton, {
          link: bug.link
        })
      ]
    }, bug.description + bug.link);
  });
  return /* @__PURE__ */ jsx245("div", {
    children: bugElements
  });
};

// src/components/UpdateModal/UpdateModal.tsx
import { jsx as jsx246, jsxs as jsxs129, Fragment as Fragment41 } from "react/jsx-runtime";
var container58 = {
  padding: 20,
  paddingTop: 0
};
...
var UpdateModal = ({ info, knownBugs }) => {
  const hasKnownBugs = useMemo121(() => {
    return knownBugs && knownBugs?.length > 0;
  }, [knownBugs]);
  const command = commands[info.packageManager];
  const onClick = useCallback122(() => {
    copyText(command).catch((err) => {
      showNotification(`Could not copy: ${err.message}`, 2000);
    });
  }, [command]);
  return /* @__PURE__ */ jsxs129(DismissableModal, {
    children: [
      /* @__PURE__ */ jsx246(ModalHeader, {
        title: "Update available"
      }),
      /* @__PURE__ */ jsxs129("div", {
        style: container58,
        children: [
          hasKnownBugs ? /* @__PURE__ */ jsxs129(Fragment41, {
            children: [
              /* @__PURE__ */ jsxs129("div", {
                style: title7,
                children: [
          ...
          /* @__PURE__ */ jsxs129(Row, {
            align: "center",
            children: [
              /* @__PURE__ */ jsx246(Flex, {
                children: /* @__PURE__ */ jsx246("pre", {
                  onClick,
                  style: code,
                  children: command
                })
...
// src/components/Modals.tsx
import { jsx as jsx247, jsxs as jsxs130, Fragment as Fragment42 } from "react/jsx-runtime";
var Modals = ({ readOnlyStudio }) => {
  ...
  return /* @__PURE__ */ jsxs130(Fragment42, {
    children: [
      modalContextType && modalContextType.type === "duplicate-comp" && /* @__PURE__ */ jsx247(DuplicateComposition, {
        compositionType: modalContextType.compositionType,
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "delete-comp" && /* @__PURE__ */ jsx247(DeleteComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "rename-comp" && /* @__PURE__ */ jsx247(RenameComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && canRender && modalContextType.type === "render" && /* @__PURE__ */ jsx247(RenderModalWithLoader, {
      ...
      modalContextType && canRender && modalContextType.type === "render-progress" && /* @__PURE__ */ jsx247(RenderStatusModal, {
        jobId: modalContextType.jobId
      }),
      modalContextType && modalContextType.type === "update" && /* @__PURE__ */ jsx247(UpdateModal, {
        info: modalContextType.info,
        knownBugs: modalContextType.knownBugs
      }),
      modalContextType && modalContextType.type === "install-packages" && /* @__PURE__ */ jsx247(InstallPackageModal, {
        packageManager: modalContextType.packageManager
      }),
      modalContextType && modalContextType.type === "quick-switcher" && /* @__PURE__ */ jsx247(QuickSwitcher_default, {
        readOnlyStudio,
...
// src/components/Editor.tsx
import { jsx as jsx248, jsxs as jsxs131 } from "react/jsx-runtime";
var background2 = {
  backgroundColor: BACKGROUND,
  display: "flex",
  width: "100%",
...
var Editor = ({ Root, readOnlyStudio }) => {
  ...
  const [canvasMounted, setCanvasMounted] = React166.useState(false);
  const onMounted = useCallback123(() => {
    setCanvasMounted(true);
  }, []);
  const value = useMemo122(() => {
    if (!size4) {
      return null;
    }
    return {
  ...
  const MemoRoot = useMemo122(() => {
    return React166.memo(Root);
  }, [Root]);
  return /* @__PURE__ */ jsx248(HigherZIndex, {
    onEscape: noop,
    onOutsideClick: noop,
    children: /* @__PURE__ */ jsxs131(TimelineZoomContext, {
      children: [
        /* @__PURE__ */ jsx248(Internals58.CurrentScaleContext.Provider, {
          value,
          children: /* @__PURE__ */ jsxs131("div", {
            style: background2,
            children: [
              canvasMounted ? /* @__PURE__ */ jsx248(MemoRoot, {}) : null,
              /* @__PURE__ */ jsxs131(Internals58.CanUseRemotionHooksProvider, {
                children: [
                  /* @__PURE__ */ jsx248(EditorContent, {
                    readOnlyStudio,
                    children: /* @__PURE__ */ jsx248(TopPanel, {
                      drawRef,
                  ...
                  /* @__PURE__ */ jsx248(GlobalKeybindings, {})
                ]
              })
            ]
          })
        }),
        /* @__PURE__ */ jsx248(Modals, {
          readOnlyStudio
        }),
        /* @__PURE__ */ jsx248(NotificationCenter, {})
      ]
    })
  });
};
...
import { useCallback as useCallback124, useContext as useContext79, useMemo as useMemo123, useState as useState73 } from "react";
...
var PreviewSizeProvider = ({ children }) => {
  const [size4, setSizeState] = useState73(() => loadPreviewSizeOption());
  const [translation, setTranslation] = useState73(() => {
    return {
      x: 0,
      y: 0
    };
  ...
  const setSize = useCallback124((newValue) => {
  ...
  const previewSizeCtx = useMemo123(() => {
    return {
  ...
  return /* @__PURE__ */ jsx249(Internals59.PreviewSizeContext.Provider, {
...
import { useCallback as useCallback125, useMemo as useMemo124, useState as useState74 } from "react";
import { jsx as jsx250 } from "react/jsx-runtime";
var CheckerboardProvider = ({ children }) => {
  const [checkerboard, setCheckerboardState] = useState74(() => loadCheckerboardOption());
  const setCheckerboard = useCallback125((newValue) => {
  ...
  const checkerboardCtx = useMemo124(() => {
    return {
      checkerboard,
      setCheckerboard
    };
  }, [checkerboard, setCheckerboard]);
  return /* @__PURE__ */ jsx250(CheckerboardContext.Provider, {
...
import { useMemo as useMemo125, useState as useState75 } from "react";
import { Internals as Internals60 } from "remotion";
import { jsx as jsx251 } from "react/jsx-runtime";
var MediaVolumeProvider = ({ children }) => {
  const [mediaMuted, setMediaMuted] = useState75(() => loadMuteOption());
  const [mediaVolume, setMediaVolume] = useState75(1);
  const mediaVolumeContextValue = useMemo125(() => {
    return {
      mediaMuted,
      mediaVolume
    };
  }, [mediaMuted, mediaVolume]);
  const setMediaVolumeContextValue = useMemo125(() => {
    return {
      setMediaMuted,
      setMediaVolume
    };
  }, []);
  return /* @__PURE__ */ jsx251(Internals60.MediaVolumeContext.Provider, {
    value: mediaVolumeContextValue,
    children: /* @__PURE__ */ jsx251(Internals60.SetMediaVolumeContext.Provider, {
...
import { useMemo as useMemo126, useState as useState76 } from "react";
import { jsx as jsx252 } from "react/jsx-runtime";
var ModalsProvider = ({ children }) => {
  const [modalContextType, setModalContextType] = useState76(null);
  const modalsContext = useMemo126(() => {
    return {
      selectedModal: modalContextType,
      setSelectedModal: setModalContextType
    };
  }, [modalContextType]);
  return /* @__PURE__ */ jsx252(ModalsContext.Provider, {
    value: modalsContext,
    children
  });
};
...
import { useEffect as useEffect72, useMemo as useMemo127, useState as useState77 } from "react";
...
var SetTimelineInOutProvider = ({ children }) => {
  const [inAndOutFrames, setInAndOutFrames] = useState77(() => loadMarks());
  const setTimelineInOutContextValue = useMemo127(() => {
    return {
      setInAndOutFrames
    };
  }, []);
  ...
  return /* @__PURE__ */ jsx253(TimelineInOutContext.Provider, {
    value: inAndOutFrames,
    children: /* @__PURE__ */ jsx253(SetTimelineInOutContext.Provider, {
...
import { useCallback as useCallback126, useMemo as useMemo128, useRef as useRef38, useState as useState78 } from "react";
import { jsx as jsx254 } from "react/jsx-runtime";
var ShowGuidesProvider = ({ children }) => {
  const [guidesList, setGuidesList] = useState78(() => loadGuidesList());
  const [selectedGuideId, setSelectedGuideId] = useState78(null);
  const [hoveredGuideId, setHoveredGuideId] = useState78(null);
  const [editorShowGuides, setEditorShowGuidesState] = useState78(() => loadEditorShowGuidesOption());
  const shouldCreateGuideRef = useRef38(false);
  const shouldDeleteGuideRef = useRef38(false);
  const setEditorShowGuides = useCallback126((newValue) => {
  ...
  const editorShowGuidesCtx = useMemo128(() => {
    return {
      editorShowGuides,
      setEditorShowGuides,
      guidesList,
  ...
  return /* @__PURE__ */ jsx254(EditorShowGuidesContext.Provider, {
...
import { useCallback as useCallback127, useMemo as useMemo129, useState as useState79 } from "react";
import { jsx as jsx255 } from "react/jsx-runtime";
var ShowRulersProvider = ({ children }) => {
  const [editorShowRulers, setEditorShowRulersState] = useState79(() => loadEditorShowRulersOption());
  const setEditorShowRulers = useCallback127((newValue) => {
  ...
  const editorShowRulersCtx = useMemo129(() => {
    return {
      editorShowRulers,
      setEditorShowRulers
    };
  }, [editorShowRulers, setEditorShowRulers]);
  return /* @__PURE__ */ jsx255(EditorShowRulersContext.Provider, {
...
import { useCallback as useCallback128, useMemo as useMemo130, useState as useState80 } from "react";
import { jsx as jsx256 } from "react/jsx-runtime";
var ZoomGesturesProvider = ({ children }) => {
  const [editorZoomGestures, setEditorZoomGesturesState] = useState80(() => loadEditorZoomGesturesOption());
  const setEditorZoomGestures = useCallback128((newValue) => {
  ...
  const editorZoomGesturesCtx = useMemo130(() => {
    return {
      editorZoomGestures,
      setEditorZoomGestures
    };
  }, [editorZoomGestures, setEditorZoomGestures]);
  return /* @__PURE__ */ jsx256(EditorZoomGesturesContext.Provider, {
...
var EditorContexts = ({ children, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx257(ZodProvider, {
    children: /* @__PURE__ */ jsx257(PreviewServerConnection, {
      readOnlyStudio,
      children: /* @__PURE__ */ jsx257(RenderQueueContextProvider, {
        children: /* @__PURE__ */ jsx257(KeybindingContextProvider, {
          children: /* @__PURE__ */ jsx257(CheckerboardProvider, {
            children: /* @__PURE__ */ jsx257(ZoomGesturesProvider, {
              children: /* @__PURE__ */ jsx257(ShowRulersProvider, {
                children: /* @__PURE__ */ jsx257(ShowGuidesProvider, {
                  children: /* @__PURE__ */ jsx257(PreviewSizeProvider, {
                    children: /* @__PURE__ */ jsx257(ModalsProvider, {
                      children: /* @__PURE__ */ jsx257(MediaVolumeProvider, {
                        children: /* @__PURE__ */ jsx257(PlayerInternals20.PlayerEmitterProvider, {
                          currentPlaybackRate: null,
                          children: /* @__PURE__ */ jsx257(SidebarContextProvider, {
                            children: /* @__PURE__ */ jsx257(FolderContextProvider, {
                              children: /* @__PURE__ */ jsx257(HighestZIndexProvider, {
                                children: /* @__PURE__ */ jsx257(SetTimelineInOutProvider, {
                                  children
                                })
                              })
                            })
...
import { jsx as jsx258, jsxs as jsxs132 } from "react/jsx-runtime";
var container59 = {
  position: "fixed",
  justifyContent: "flex-end",
  alignItems: "flex-start",
  ...
  return /* @__PURE__ */ jsx258("div", {
    ...
    children: /* @__PURE__ */ jsxs132("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx258("br", {}),
        window.remotion_studioServerCommand ? /* @__PURE__ */ jsxs132("span", {
          children: [
            "Run",
            " ",
            /* @__PURE__ */ jsx258("code", {
              style: inlineCode,
...
// src/Studio.tsx
import { jsx as jsx259, jsxs as jsxs133 } from "react/jsx-runtime";
...
var Studio = ({ rootComponent, readOnly }) => {
  ...
  return /* @__PURE__ */ jsx259(Internals62.RemotionRoot, {
    numberOfAudioTags: window.remotion_numberOfAudioTags,
    children: /* @__PURE__ */ jsxs133(EditorContexts, {
      readOnlyStudio: readOnly,
      children: [
        /* @__PURE__ */ jsx259(Editor, {
          readOnlyStudio: readOnly,
          Root: rootComponent
        }),
        readOnly ? null : createPortal(/* @__PURE__ */ jsx259(ServerDisconnected, {}), getServerDisconnectedDomElement())
      ]
    })
  });
};
