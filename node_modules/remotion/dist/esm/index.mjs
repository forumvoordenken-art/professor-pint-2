...
// src/Artifact.tsx
import { useContext as useContext11, useEffect as useEffect4, useState as useState6 } from "react";
...
var RenderAssetManagerProvider = ({ children }) => {
  const [renderAssets, setRenderAssets] = useState5([]);
  ...
  return /* @__PURE__ */ jsx9(RenderAssetManager.Provider, {
    value: contextValue,
    children
  });
};
...
var Artifact = ({ filename, content }) => {
  ...
  const [env] = useState6(() => getRemotionEnvironment());
  const frame = useCurrentFrame();
  const [id] = useState6(() => {
...
// src/audio/Audio.tsx
import { forwardRef as forwardRef5, useCallback as useCallback9, useContext as useContext21 } from "react";
...
var Loop = ({ durationInFrames, times = Infinity, children, name, ...props }) => {
  ...
  return /* @__PURE__ */ jsx10(LoopContext.Provider, {
    value: loopContext,
    children: /* @__PURE__ */ jsx10(Sequence, {
      durationInFrames,
      from,
      name: name ?? "<Loop>",
      _remotionInternalLoopDisplay: loopDisplay,
...
import { createContext as createContext12, useEffect as useEffect5, useState as useState7 } from "react";
...
var PrefetchProvider = ({ children }) => {
  const [_preloads, _setPreloads] = useState7(() => preloads);
  useEffect5(() => {
  ...
  return /* @__PURE__ */ jsx11(PreloadContext.Provider, {
    value: _preloads,
    children
  });
};
...
var DurationsContextProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx12(DurationsContext.Provider, {
    value,
    children
  });
};
...
import { useContext as useContext14, useEffect as useEffect6, useMemo as useMemo13, useState as useState8 } from "react";
...
import { useCallback as useCallback7, useContext as useContext16, useEffect as useEffect10, useRef as useRef6 } from "react";

// src/buffer-until-first-frame.ts
import { useCallback as useCallback6, useMemo as useMemo16, useRef as useRef3 } from "react";

// src/use-buffer-state.ts
import { useContext as useContext15, useMemo as useMemo15 } from "react";

// src/buffering.tsx
import React11, { useCallback as useCallback5, useEffect as useEffect7, useMemo as useMemo14, useRef as useRef2, useState as useState9 } from "react";
import { jsx as jsx13 } from "react/jsx-runtime";
var useBufferManager = () => {
  const [blocks, setBlocks] = useState9([]);
  const [onBufferingCallbacks, setOnBufferingCallbacks] = useState9([]);
  const [onResumeCallbacks, setOnResumeCallbacks] = useState9([]);
...
var BufferingProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx13(BufferingContextReact.Provider, {
    value: bufferManager,
    children
  });
};
var useIsPlayerBuffering = (bufferManager) => {
  const [isBuffering, setIsBuffering] = useState9(bufferManager.buffering.current);
  useEffect7(() => {
    const onBuffer = () => {
      setIsBuffering(true);
    };
...
var useMediaBuffering = ({
  ...
  const [isBuffering, setIsBuffering] = useState10(false);
  useEffect8(() => {
    let cleanupFns = [];
...
var AudioRefForwardingFunction = (props, ref) => {
  ...
  if (typeof startFrom !== "undefined" || typeof endAt !== "undefined") {
    ...
    return /* @__PURE__ */ jsx17(Sequence, {
      layout: "none",
  ...
  if (environment.isRendering) {
    return /* @__PURE__ */ jsx17(AudioForRendering, {
      onDuration,
      ...props,
      ref,
      onError,
  ...
  return /* @__PURE__ */ jsx17(AudioForPreview, {
...
var Folder = ({ name, children }) => {
  ...
  return /* @__PURE__ */ jsx18(FolderContext.Provider, {
    value,
    children
  });
};
...
var Composition = ({
  ...
  if (environment.isStudio && video && video.component === lazy) {
    ...
    return createPortal(/* @__PURE__ */ jsx20(CanUseRemotionHooksProvider, {
      children: /* @__PURE__ */ jsx20(Suspense, {
        fallback: /* @__PURE__ */ jsx20(Loading, {}),
        children: /* @__PURE__ */ jsx20(Comp, {
  ...
  if (environment.isRendering && video && video.component === lazy) {
    ...
    return createPortal(/* @__PURE__ */ jsx20(CanUseRemotionHooksProvider, {
      children: /* @__PURE__ */ jsx20(Suspense, {
        fallback: /* @__PURE__ */ jsx20(Fallback, {}),
        children: /* @__PURE__ */ jsx20(Comp, {
          ...resolved.result.props ?? {}
        })
      })
...
var CompositionManagerProvider = ({ children, numberOfAudioTags }) => {
  ...
  return /* @__PURE__ */ jsx21(CompositionManager.Provider, {
    value: contextValue,
    children: /* @__PURE__ */ jsx21(SequenceManagerProvider, {
      children: /* @__PURE__ */ jsx21(RenderAssetManagerProvider, {
        children: /* @__PURE__ */ jsx21(ResolveCompositionConfig, {
          children: /* @__PURE__ */ jsx21(SharedAudioContextProvider, {
            numberOfAudioTags,
...
// src/IFrame.tsx
import { forwardRef as forwardRef6, useCallback as useCallback11, useState as useState15 } from "react";
...
var RemotionRoot = ({ children, numberOfAudioTags }) => {
  ...
  return /* @__PURE__ */ jsx24(NonceContext.Provider, {
    value: nonceContext,
    children: /* @__PURE__ */ jsx24(TimelineContext.Provider, {
      value: timelineContextValue,
      children: /* @__PURE__ */ jsx24(SetTimelineContext.Provider, {
        value: setTimelineContextValue,
        children: /* @__PURE__ */ jsx24(EditorPropsProvider, {
          children: /* @__PURE__ */ jsx24(PrefetchProvider, {
            children: /* @__PURE__ */ jsx24(CompositionManagerProvider, {
              numberOfAudioTags,
              children: /* @__PURE__ */ jsx24(DurationsContextProvider, {
                children: /* @__PURE__ */ jsx24(BufferingProvider, {
                  children
                })
              })
            })
...
var RemotionContextProvider = (props2) => {
  ...
  return /* @__PURE__ */ jsx25(CanUseRemotionHooks.Provider, {
    ...
    children: /* @__PURE__ */ jsx25(NonceContext.Provider, {
      value: contexts.nonceContext,
      children: /* @__PURE__ */ jsx25(PreloadContext.Provider, {
        value: contexts.preloadContext,
        children: /* @__PURE__ */ jsx25(CompositionManager.Provider, {
          value: contexts.compositionManagerCtx,
          children: /* @__PURE__ */ jsx25(SequenceManager.Provider, {
            value: contexts.sequenceManagerContext,
            children: /* @__PURE__ */ jsx25(RenderAssetManager.Provider, {
              value: contexts.renderAssetManagerContext,
              children: /* @__PURE__ */ jsx25(ResolveCompositionContext.Provider, {
                value: contexts.resolveCompositionContext,
                children: /* @__PURE__ */ jsx25(TimelineContext.Provider, {
                  value: contexts.timelineContext,
                  children: /* @__PURE__ */ jsx25(SetTimelineContext.Provider, {
                    value: contexts.setTimelineContext,
                    children: /* @__PURE__ */ jsx25(SequenceContext.Provider, {
                      value: contexts.sequenceContext,
                      children: /* @__PURE__ */ jsx25(BufferingContextReact.Provider, {
...
import { Children, forwardRef as forwardRef8, useMemo as useMemo26 } from "react";
...
var IsInsideSeriesContainer = ({ children }) => {
  return /* @__PURE__ */ jsx26(IsInsideSeriesContext.Provider, {
    value: true,
    children
  });
};
...
var SeriesSequenceRefForwardingFunction = ({ children }, _ref) => {
  ...
  return /* @__PURE__ */ jsx27(IsNotInsideSeriesProvider, {
    children
  });
};
...
var Series = (props2) => {
  ...
  if (ENABLE_V5_BREAKING_CHANGES) {
    return /* @__PURE__ */ jsx27(IsInsideSeriesContainer, {
...
var OffthreadVideo = (props2) => {
  ...
  if (typeof startFrom !== "undefined" || typeof endAt !== "undefined") {
    ...
    return /* @__PURE__ */ jsx30(Sequence, {
      ...
      durationInFrames: endAtFrameNo,
      name,
      children: /* @__PURE__ */ jsx30(OffthreadVideo, {
        pauseWhenBuffering: pauseWhenBuffering ?? false,
        ...otherProps
      })
    });
...
// src/video/Video.tsx
import { forwardRef as forwardRef11, useCallback as useCallback15, useContext as useContext28 } from "react";
...
var VideoForwardingFunction = (props2, ref) => {
  ...
  validateMediaProps(props2, "Video");
  if (environment.isRendering) {
    return /* @__PURE__ */ jsx32(VideoForRendering, {
      onDuration,
      onVideoFrame: onVideoFrame ?? null,
      ...otherProps,
      ref
